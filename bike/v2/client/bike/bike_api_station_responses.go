...
func (o *BikeAPIStationReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 299:
		result := NewBikeAPIStationStatus299()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
...
func NewBikeAPIStationStatus299() *BikeAPIStationStatus299 {
	return &BikeAPIStationStatus299{}
}
...
func (o *BikeAPIStationStatus299) Error() string {
	return fmt.Sprintf("[GET /v2/Bike/Station/{City}][%d] bikeApiStationStatus299  %+v", 299, o.Payload)
}
func (o *BikeAPIStationStatus299) GetPayload() *models.PTXServiceDTOSharedSpecificationV3BaseDisplayHealth {
	return o.Payload
}

func (o *BikeAPIStationStatus299) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
