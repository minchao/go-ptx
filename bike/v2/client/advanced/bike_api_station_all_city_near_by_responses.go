...
func (o *BikeAPIStationAllCityNearByReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 299:
		result := NewBikeAPIStationAllCityNearByStatus299()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
...
func NewBikeAPIStationAllCityNearByStatus299() *BikeAPIStationAllCityNearByStatus299 {
	return &BikeAPIStationAllCityNearByStatus299{}
}
...
func (o *BikeAPIStationAllCityNearByStatus299) Error() string {
	return fmt.Sprintf("[GET /v2/Bike/Station/NearBy][%d] bikeApiStationAllCityNearByStatus299  %+v", 299, o.Payload)
}
func (o *BikeAPIStationAllCityNearByStatus299) GetPayload() *models.PTXServiceDTOSharedSpecificationV3BaseDisplayHealth {
	return o.Payload
}

func (o *BikeAPIStationAllCityNearByStatus299) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
