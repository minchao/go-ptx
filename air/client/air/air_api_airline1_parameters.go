...
func (o *AirAPIAirline1Params) WithContext(ctx context.Context) *AirAPIAirline1Params {
	o.SetContext(ctx)
	return o
}
...
func (o *AirAPIAirline1Params) WithDollarTop(dollarTop *string) *AirAPIAirline1Params {
	o.SetDollarTop(dollarTop)
	return o
}

// SetDollarTop adds the dollarTop to the air Api airline 1 params
func (o *AirAPIAirline1Params) SetDollarTop(dollarTop *string) {
