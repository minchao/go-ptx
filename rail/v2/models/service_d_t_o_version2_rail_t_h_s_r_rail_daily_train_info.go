...
var serviceDTOVersion2RailTHSRRailDailyTrainInfoTypeDirectionPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		serviceDTOVersion2RailTHSRRailDailyTrainInfoTypeDirectionPropEnum = append(serviceDTOVersion2RailTHSRRailDailyTrainInfoTypeDirectionPropEnum, v)
	}
}

// prop value enum
func (m *ServiceDTOVersion2RailTHSRRailDailyTrainInfo) validateDirectionEnum(path, location string, value int64) error {
	if err := validate.Enum(path, location, value, serviceDTOVersion2RailTHSRRailDailyTrainInfoTypeDirectionPropEnum); err != nil {
		return err
	}
	return nil
}
