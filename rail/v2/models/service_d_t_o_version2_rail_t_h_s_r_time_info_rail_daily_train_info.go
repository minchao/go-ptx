...
var serviceDTOVersion2RailTHSRTimeInfoRailDailyTrainInfoTypeDirectionPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		serviceDTOVersion2RailTHSRTimeInfoRailDailyTrainInfoTypeDirectionPropEnum = append(serviceDTOVersion2RailTHSRTimeInfoRailDailyTrainInfoTypeDirectionPropEnum, v)
	}
}

// prop value enum
func (m *ServiceDTOVersion2RailTHSRTimeInfoRailDailyTrainInfo) validateDirectionEnum(path, location string, value int64) error {
	if err := validate.Enum(path, location, value, serviceDTOVersion2RailTHSRTimeInfoRailDailyTrainInfoTypeDirectionPropEnum); err != nil {
		return err
	}
	return nil
}
