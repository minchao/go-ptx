...
var serviceDTOVersion2RailTRATimeInfoRailGeneralTrainInfoTypeBikeFlagPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		serviceDTOVersion2RailTRATimeInfoRailGeneralTrainInfoTypeBikeFlagPropEnum = append(serviceDTOVersion2RailTRATimeInfoRailGeneralTrainInfoTypeBikeFlagPropEnum, v)
	}
}

// prop value enum
func (m *ServiceDTOVersion2RailTRATimeInfoRailGeneralTrainInfo) validateBikeFlagEnum(path, location string, value int64) error {
	if err := validate.Enum(path, location, value, serviceDTOVersion2RailTRATimeInfoRailGeneralTrainInfoTypeBikeFlagPropEnum); err != nil {
		return err
	}
	return nil
}
...
var serviceDTOVersion2RailTRATimeInfoRailGeneralTrainInfoTypeBreastFeedingFlagPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		serviceDTOVersion2RailTRATimeInfoRailGeneralTrainInfoTypeBreastFeedingFlagPropEnum = append(serviceDTOVersion2RailTRATimeInfoRailGeneralTrainInfoTypeBreastFeedingFlagPropEnum, v)
	}
}

// prop value enum
func (m *ServiceDTOVersion2RailTRATimeInfoRailGeneralTrainInfo) validateBreastFeedingFlagEnum(path, location string, value int64) error {
	if err := validate.Enum(path, location, value, serviceDTOVersion2RailTRATimeInfoRailGeneralTrainInfoTypeBreastFeedingFlagPropEnum); err != nil {
		return err
	}
	return nil
}
...
var serviceDTOVersion2RailTRATimeInfoRailGeneralTrainInfoTypeDailyFlagPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		serviceDTOVersion2RailTRATimeInfoRailGeneralTrainInfoTypeDailyFlagPropEnum = append(serviceDTOVersion2RailTRATimeInfoRailGeneralTrainInfoTypeDailyFlagPropEnum, v)
	}
}

// prop value enum
func (m *ServiceDTOVersion2RailTRATimeInfoRailGeneralTrainInfo) validateDailyFlagEnum(path, location string, value int64) error {
	if err := validate.Enum(path, location, value, serviceDTOVersion2RailTRATimeInfoRailGeneralTrainInfoTypeDailyFlagPropEnum); err != nil {
		return err
	}
	return nil
}
...
var serviceDTOVersion2RailTRATimeInfoRailGeneralTrainInfoTypeDiningFlagPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		serviceDTOVersion2RailTRATimeInfoRailGeneralTrainInfoTypeDiningFlagPropEnum = append(serviceDTOVersion2RailTRATimeInfoRailGeneralTrainInfoTypeDiningFlagPropEnum, v)
	}
}

// prop value enum
func (m *ServiceDTOVersion2RailTRATimeInfoRailGeneralTrainInfo) validateDiningFlagEnum(path, location string, value int64) error {
	if err := validate.Enum(path, location, value, serviceDTOVersion2RailTRATimeInfoRailGeneralTrainInfoTypeDiningFlagPropEnum); err != nil {
		return err
	}
	return nil
}
...
var serviceDTOVersion2RailTRATimeInfoRailGeneralTrainInfoTypeDirectionPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		serviceDTOVersion2RailTRATimeInfoRailGeneralTrainInfoTypeDirectionPropEnum = append(serviceDTOVersion2RailTRATimeInfoRailGeneralTrainInfoTypeDirectionPropEnum, v)
	}
}

// prop value enum
func (m *ServiceDTOVersion2RailTRATimeInfoRailGeneralTrainInfo) validateDirectionEnum(path, location string, value int64) error {
	if err := validate.Enum(path, location, value, serviceDTOVersion2RailTRATimeInfoRailGeneralTrainInfoTypeDirectionPropEnum); err != nil {
		return err
	}
	return nil
}
...
var serviceDTOVersion2RailTRATimeInfoRailGeneralTrainInfoTypePackageServiceFlagPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		serviceDTOVersion2RailTRATimeInfoRailGeneralTrainInfoTypePackageServiceFlagPropEnum = append(serviceDTOVersion2RailTRATimeInfoRailGeneralTrainInfoTypePackageServiceFlagPropEnum, v)
	}
}

// prop value enum
func (m *ServiceDTOVersion2RailTRATimeInfoRailGeneralTrainInfo) validatePackageServiceFlagEnum(path, location string, value int64) error {
	if err := validate.Enum(path, location, value, serviceDTOVersion2RailTRATimeInfoRailGeneralTrainInfoTypePackageServiceFlagPropEnum); err != nil {
		return err
	}
	return nil
}
...
var serviceDTOVersion2RailTRATimeInfoRailGeneralTrainInfoTypeTripLinePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		serviceDTOVersion2RailTRATimeInfoRailGeneralTrainInfoTypeTripLinePropEnum = append(serviceDTOVersion2RailTRATimeInfoRailGeneralTrainInfoTypeTripLinePropEnum, v)
	}
}

// prop value enum
func (m *ServiceDTOVersion2RailTRATimeInfoRailGeneralTrainInfo) validateTripLineEnum(path, location string, value int64) error {
	if err := validate.Enum(path, location, value, serviceDTOVersion2RailTRATimeInfoRailGeneralTrainInfoTypeTripLinePropEnum); err != nil {
		return err
	}
	return nil
}

func (m *ServiceDTOVersion2RailTRATimeInfoRailGeneralTrainInfo) validateTripLine(formats strfmt.Registry) error {
...
var serviceDTOVersion2RailTRATimeInfoRailGeneralTrainInfoTypeWheelchairFlagPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		serviceDTOVersion2RailTRATimeInfoRailGeneralTrainInfoTypeWheelchairFlagPropEnum = append(serviceDTOVersion2RailTRATimeInfoRailGeneralTrainInfoTypeWheelchairFlagPropEnum, v)
	}
}

// prop value enum
func (m *ServiceDTOVersion2RailTRATimeInfoRailGeneralTrainInfo) validateWheelchairFlagEnum(path, location string, value int64) error {
	if err := validate.Enum(path, location, value, serviceDTOVersion2RailTRATimeInfoRailGeneralTrainInfoTypeWheelchairFlagPropEnum); err != nil {
		return err
	}
	return nil
}
