...
// WithHealth adds the health to the metro Api station params
func (o *MetroAPIStationParams) WithHealth(health *string) *MetroAPIStationParams {
	o.SetHealth(health)
	return o
}

// SetHealth adds the health to the metro Api station params
func (o *MetroAPIStationParams) SetHealth(health *string) {
	o.Health = health
}
