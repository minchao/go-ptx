...
func (o *MetroAPIStationOfRouteReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 299:
		result := NewMetroAPIStationOfRouteStatus299()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
...
// NewMetroAPIStationOfRouteStatus299 creates a MetroAPIStationOfRouteStatus299 with default headers values
func NewMetroAPIStationOfRouteStatus299() *MetroAPIStationOfRouteStatus299 {
	return &MetroAPIStationOfRouteStatus299{}
}

/* MetroAPIStationOfRouteStatus299 describes a response with status code 299, with default header values.

加入參數'?health=true'即可查詢此API服務的健康狀態
*/
type MetroAPIStationOfRouteStatus299 struct {
	Payload *models.PTXServiceDTOSharedSpecificationV3BaseDisplayHealth
}

func (o *MetroAPIStationOfRouteStatus299) Error() string {
	return fmt.Sprintf("[GET /v2/Rail/Metro/StationOfRoute/{Operator}][%d] metroApiStationOfRouteStatus299  %+v", 299, o.Payload)
}
func (o *MetroAPIStationOfRouteStatus299) GetPayload() *models.PTXServiceDTOSharedSpecificationV3BaseDisplayHealth {
	return o.Payload
}

func (o *MetroAPIStationOfRouteStatus299) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
