...
func (o *MetroAPILine2091Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewMetroAPILine2091OK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 299:
		result := NewMetroAPILine2091Status299()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 304:
		result := NewMetroAPILine2091NotModified()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *MetroAPILine2091OK) Error() string {
	return fmt.Sprintf("[GET /v2/Rail/Metro/Line/{MetroSystem}][%d] metroApiLine2091OK  %+v", 200, o.Payload)
}
func (o *MetroAPILine2091OK) GetPayload() []*models.PTXServiceDTORailSpecificationV2MetroLine {
	return o.Payload
}

func (o *MetroAPILine2091OK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewMetroAPILine2091Status299() *MetroAPILine2091Status299 {
	return &MetroAPILine2091Status299{}
}
...
func (o *MetroAPILine2091Status299) Error() string {
	return fmt.Sprintf("[GET /v2/Rail/Metro/Line/{MetroSystem}][%d] metroApiLine2091Status299  %+v", 299, o.Payload)
}
func (o *MetroAPILine2091Status299) GetPayload() *models.PTXServiceDTOSharedSpecificationV3BaseDisplayHealth {
	return o.Payload
}

func (o *MetroAPILine2091Status299) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewMetroAPILine2091NotModified() *MetroAPILine2091NotModified {
	return &MetroAPILine2091NotModified{}
}
...
func (o *MetroAPILine2091NotModified) Error() string {
	return fmt.Sprintf("[GET /v2/Rail/Metro/Line/{MetroSystem}][%d] metroApiLine2091NotModified ", 304)
}

func (o *MetroAPILine2091NotModified) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
