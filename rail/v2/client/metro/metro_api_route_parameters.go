...
// WithHealth adds the health to the metro Api route params
func (o *MetroAPIRouteParams) WithHealth(health *string) *MetroAPIRouteParams {
	o.SetHealth(health)
	return o
}

// SetHealth adds the health to the metro Api route params
func (o *MetroAPIRouteParams) SetHealth(health *string) {
	o.Health = health
}
