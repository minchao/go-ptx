...
// WithHealth adds the health to the metro Api s2 s travel time params
func (o *MetroAPIS2STravelTimeParams) WithHealth(health *string) *MetroAPIS2STravelTimeParams {
	o.SetHealth(health)
	return o
}

// SetHealth adds the health to the metro Api s2 s travel time params
func (o *MetroAPIS2STravelTimeParams) SetHealth(health *string) {
	o.Health = health
}
