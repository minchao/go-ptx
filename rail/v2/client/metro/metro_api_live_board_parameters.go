...
// WithHealth adds the health to the metro Api live board params
func (o *MetroAPILiveBoardParams) WithHealth(health *string) *MetroAPILiveBoardParams {
	o.SetHealth(health)
	return o
}

// SetHealth adds the health to the metro Api live board params
func (o *MetroAPILiveBoardParams) SetHealth(health *string) {
	o.Health = health
}
