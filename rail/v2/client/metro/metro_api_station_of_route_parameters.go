...
// WithHealth adds the health to the metro Api station of route params
func (o *MetroAPIStationOfRouteParams) WithHealth(health *string) *MetroAPIStationOfRouteParams {
	o.SetHealth(health)
	return o
}

// SetHealth adds the health to the metro Api station of route params
func (o *MetroAPIStationOfRouteParams) SetHealth(health *string) {
	o.Health = health
}
