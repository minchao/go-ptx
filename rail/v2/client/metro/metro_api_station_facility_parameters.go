...
// WithHealth adds the health to the metro Api station facility params
func (o *MetroAPIStationFacilityParams) WithHealth(health *string) *MetroAPIStationFacilityParams {
	o.SetHealth(health)
	return o
}

// SetHealth adds the health to the metro Api station facility params
func (o *MetroAPIStationFacilityParams) SetHealth(health *string) {
	o.Health = health
}
