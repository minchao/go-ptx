...
// NewMetroAPIFrequency2100Params creates a new MetroAPIFrequency2100Params object,
...
func NewMetroAPIFrequency2100Params() *MetroAPIFrequency2100Params {
	return &MetroAPIFrequency2100Params{
		timeout: cr.DefaultTimeout,
	}
}

// NewMetroAPIFrequency2100ParamsWithTimeout creates a new MetroAPIFrequency2100Params object
...
// NewMetroAPIFrequency2100ParamsWithContext creates a new MetroAPIFrequency2100Params object
...
// NewMetroAPIFrequency2100ParamsWithHTTPClient creates a new MetroAPIFrequency2100Params object
...
type MetroAPIFrequency2100Params struct {
	...
	*/
	...
	/* RailSystem.
	   ...
	   欲查詢軌道系統(TRTC:臺北捷運,TYMC:桃園捷運,TMRT:臺中捷運)
	*/
	RailSystem string
...
func (o *MetroAPIFrequency2100Params) WithDefaults() *MetroAPIFrequency2100Params {
	o.SetDefaults()
	return o
}
...
func (o *MetroAPIFrequency2100Params) SetDefaults() {
	...
	val := MetroAPIFrequency2100Params{
...
func (o *MetroAPIFrequency2100Params) WithTimeout(timeout time.Duration) *MetroAPIFrequency2100Params {
...
func (o *MetroAPIFrequency2100Params) WithContext(ctx context.Context) *MetroAPIFrequency2100Params {
	o.SetContext(ctx)
	return o
}
...
func (o *MetroAPIFrequency2100Params) WithHTTPClient(client *http.Client) *MetroAPIFrequency2100Params {
...
// WithRailSystem adds the railSystem to the metro Api frequency 2100 params
func (o *MetroAPIFrequency2100Params) WithRailSystem(railSystem string) *MetroAPIFrequency2100Params {
	o.SetRailSystem(railSystem)
	return o
}

// SetRailSystem adds the railSystem to the metro Api frequency 2100 params
func (o *MetroAPIFrequency2100Params) SetRailSystem(railSystem string) {
	o.RailSystem = railSystem
}

// WithHealth adds the health to the metro Api frequency 2100 params
func (o *MetroAPIFrequency2100Params) WithHealth(health *string) *MetroAPIFrequency2100Params {
	o.SetHealth(health)
	return o
}
...
func (o *MetroAPIFrequency2100Params) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
