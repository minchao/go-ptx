...
// WithHealth adds the health to the metro Api frequency params
func (o *MetroAPIFrequencyParams) WithHealth(health *string) *MetroAPIFrequencyParams {
	o.SetHealth(health)
	return o
}

// SetHealth adds the health to the metro Api frequency params
func (o *MetroAPIFrequencyParams) SetHealth(health *string) {
	o.Health = health
}
