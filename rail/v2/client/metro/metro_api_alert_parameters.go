...
// WithHealth adds the health to the metro Api alert params
func (o *MetroAPIAlertParams) WithHealth(health *string) *MetroAPIAlertParams {
	o.SetHealth(health)
	return o
}

// SetHealth adds the health to the metro Api alert params
func (o *MetroAPIAlertParams) SetHealth(health *string) {
	o.Health = health
}
