...
func (o *MetroAPIStationTimeTableParams) WithDollarTop(dollarTop *string) *MetroAPIStationTimeTableParams {
	o.SetDollarTop(dollarTop)
	return o
}

// SetDollarTop adds the dollarTop to the metro Api station time table params
func (o *MetroAPIStationTimeTableParams) SetDollarTop(dollarTop *string) {
