...
// WithHealth adds the health to the metro Api station time table params
func (o *MetroAPIStationTimeTableParams) WithHealth(health *string) *MetroAPIStationTimeTableParams {
	o.SetHealth(health)
	return o
}

// SetHealth adds the health to the metro Api station time table params
func (o *MetroAPIStationTimeTableParams) SetHealth(health *string) {
	o.Health = health
}
