...
// WithHealth adds the health to the metro Api station of line params
func (o *MetroAPIStationOfLineParams) WithHealth(health *string) *MetroAPIStationOfLineParams {
	o.SetHealth(health)
	return o
}

// SetHealth adds the health to the metro Api station of line params
func (o *MetroAPIStationOfLineParams) SetHealth(health *string) {
	o.Health = health
}
