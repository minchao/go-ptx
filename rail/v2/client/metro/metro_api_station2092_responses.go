...
func (o *MetroAPIStation2092Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewMetroAPIStation2092OK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 299:
		result := NewMetroAPIStation2092Status299()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 304:
		result := NewMetroAPIStation2092NotModified()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *MetroAPIStation2092OK) Error() string {
	return fmt.Sprintf("[GET /v2/Rail/Metro/Station/{MetroSystem}][%d] metroApiStation2092OK  %+v", 200, o.Payload)
}
func (o *MetroAPIStation2092OK) GetPayload() []*models.PTXServiceDTORailSpecificationV2MetroStation {
	return o.Payload
}

func (o *MetroAPIStation2092OK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewMetroAPIStation2092Status299() *MetroAPIStation2092Status299 {
	return &MetroAPIStation2092Status299{}
}
...
func (o *MetroAPIStation2092Status299) Error() string {
	return fmt.Sprintf("[GET /v2/Rail/Metro/Station/{MetroSystem}][%d] metroApiStation2092Status299  %+v", 299, o.Payload)
}
func (o *MetroAPIStation2092Status299) GetPayload() *models.PTXServiceDTOSharedSpecificationV3BaseDisplayHealth {
	return o.Payload
}

func (o *MetroAPIStation2092Status299) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewMetroAPIStation2092NotModified() *MetroAPIStation2092NotModified {
	return &MetroAPIStation2092NotModified{}
}
...
func (o *MetroAPIStation2092NotModified) Error() string {
	return fmt.Sprintf("[GET /v2/Rail/Metro/Station/{MetroSystem}][%d] metroApiStation2092NotModified ", 304)
}

func (o *MetroAPIStation2092NotModified) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
