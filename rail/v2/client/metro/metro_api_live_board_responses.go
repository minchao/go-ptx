...
func (o *MetroAPILiveBoardReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 299:
		result := NewMetroAPILiveBoardStatus299()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
...
// NewMetroAPILiveBoardStatus299 creates a MetroAPILiveBoardStatus299 with default headers values
func NewMetroAPILiveBoardStatus299() *MetroAPILiveBoardStatus299 {
	return &MetroAPILiveBoardStatus299{}
}

/* MetroAPILiveBoardStatus299 describes a response with status code 299, with default header values.

加入參數'?health=true'即可查詢此API服務的健康狀態
*/
type MetroAPILiveBoardStatus299 struct {
	Payload *models.PTXServiceDTOSharedSpecificationV3BaseDisplayHealth
}

func (o *MetroAPILiveBoardStatus299) Error() string {
	return fmt.Sprintf("[GET /v2/Rail/Metro/LiveBoard/{Operator}][%d] metroApiLiveBoardStatus299  %+v", 299, o.Payload)
}
func (o *MetroAPILiveBoardStatus299) GetPayload() *models.PTXServiceDTOSharedSpecificationV3BaseDisplayHealth {
	return o.Payload
}

func (o *MetroAPILiveBoardStatus299) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
