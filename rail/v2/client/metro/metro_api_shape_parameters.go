...
// WithHealth adds the health to the metro Api shape params
func (o *MetroAPIShapeParams) WithHealth(health *string) *MetroAPIShapeParams {
	o.SetHealth(health)
	return o
}

// SetHealth adds the health to the metro Api shape params
func (o *MetroAPIShapeParams) SetHealth(health *string) {
	o.Health = health
}
