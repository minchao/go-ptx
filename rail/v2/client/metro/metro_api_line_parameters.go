...
// WithHealth adds the health to the metro Api line params
func (o *MetroAPILineParams) WithHealth(health *string) *MetroAPILineParams {
	o.SetHealth(health)
	return o
}

// SetHealth adds the health to the metro Api line params
func (o *MetroAPILineParams) SetHealth(health *string) {
	o.Health = health
}
