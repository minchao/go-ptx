...
func (o *THSRAPIODFare2121OK) Error() string {
	return fmt.Sprintf("[GET /v2/Rail/THSR/ODFare][%d] tHSRApiODFare2121OK  %+v", 200, o.Payload)
}
func (o *THSRAPIODFare2121OK) GetPayload() []*models.PTXServiceDTORailSpecificationV2THSRRailODFare {
	return o.Payload
}

func (o *THSRAPIODFare2121OK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewTHSRAPIODFare2121Status299() *THSRAPIODFare2121Status299 {
	return &THSRAPIODFare2121Status299{}
}
...
func (o *THSRAPIODFare2121Status299) Error() string {
	return fmt.Sprintf("[GET /v2/Rail/THSR/ODFare][%d] tHSRApiODFare2121Status299  %+v", 299, o.Payload)
}
func (o *THSRAPIODFare2121Status299) GetPayload() *models.PTXServiceDTOSharedSpecificationV3BaseDisplayHealth {
	return o.Payload
}

func (o *THSRAPIODFare2121Status299) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewTHSRAPIODFare2121NotModified() *THSRAPIODFare2121NotModified {
	return &THSRAPIODFare2121NotModified{}
}
...
func (o *THSRAPIODFare2121NotModified) Error() string {
	return fmt.Sprintf("[GET /v2/Rail/THSR/ODFare][%d] tHSRApiODFare2121NotModified ", 304)
}

func (o *THSRAPIODFare2121NotModified) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
