...
func (o *THSRAPIGeneralTimetable1Params) WithDollarTop(dollarTop *string) *THSRAPIGeneralTimetable1Params {
	o.SetDollarTop(dollarTop)
	return o
}

// SetDollarTop adds the dollarTop to the t h s r Api general timetable 1 params
func (o *THSRAPIGeneralTimetable1Params) SetDollarTop(dollarTop *string) {
