...
func (o *THSRAPIODFare1Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 299:
		result := NewTHSRAPIODFare1Status299()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
...
func NewTHSRAPIODFare1Status299() *THSRAPIODFare1Status299 {
	return &THSRAPIODFare1Status299{}
}
...
func (o *THSRAPIODFare1Status299) Error() string {
	return fmt.Sprintf("[GET /v2/Rail/THSR/ODFare/{OriginStationID}/to/{DestinationStationID}][%d] tHSRApiODFare1Status299  %+v", 299, o.Payload)
}
func (o *THSRAPIODFare1Status299) GetPayload() *models.PTXServiceDTOSharedSpecificationV3BaseDisplayHealth {
	return o.Payload
}

func (o *THSRAPIODFare1Status299) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
