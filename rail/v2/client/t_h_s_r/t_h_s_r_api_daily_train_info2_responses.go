...
func (o *THSRAPIDailyTrainInfo2Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 299:
		result := NewTHSRAPIDailyTrainInfo2Status299()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
...
func NewTHSRAPIDailyTrainInfo2Status299() *THSRAPIDailyTrainInfo2Status299 {
	return &THSRAPIDailyTrainInfo2Status299{}
}
...
func (o *THSRAPIDailyTrainInfo2Status299) Error() string {
	return fmt.Sprintf("[GET /v2/Rail/THSR/DailyTrainInfo/TrainDate/{TrainDate}][%d] tHSRApiDailyTrainInfo2Status299  %+v", 299, o.Payload)
}
func (o *THSRAPIDailyTrainInfo2Status299) GetPayload() *models.PTXServiceDTOSharedSpecificationV3BaseDisplayHealth {
	return o.Payload
}

func (o *THSRAPIDailyTrainInfo2Status299) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
