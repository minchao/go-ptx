...
func (o *THSRAPIShapeReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 299:
		result := NewTHSRAPIShapeStatus299()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
...
func (o *THSRAPIShapeStatus299) Error() string {
	return fmt.Sprintf("[GET /v2/Rail/THSR/Shape][%d] tHSRApiShapeStatus299  %+v", 299, o.Payload)
}
func (o *THSRAPIShapeStatus299) GetPayload() *models.PTXServiceDTOSharedSpecificationV3BaseDisplayHealth {
	return o.Payload
}

func (o *THSRAPIShapeStatus299) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
