...
func (o *THSRAPIAvailableSeatStatusListStation1Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 299:
		result := NewTHSRAPIAvailableSeatStatusListStation1Status299()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
...
func NewTHSRAPIAvailableSeatStatusListStation1Status299() *THSRAPIAvailableSeatStatusListStation1Status299 {
	return &THSRAPIAvailableSeatStatusListStation1Status299{}
}
...
func (o *THSRAPIAvailableSeatStatusListStation1Status299) Error() string {
	return fmt.Sprintf("[GET /v2/Rail/THSR/AvailableSeatStatusList/{StationID}][%d] tHSRApiAvailableSeatStatusListStation1Status299  %+v", 299, o.Payload)
}
...
func (o *THSRAPIAvailableSeatStatusListStation1Status299) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
