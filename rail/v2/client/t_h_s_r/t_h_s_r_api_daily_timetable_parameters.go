...
func (o *THSRAPIDailyTimetableParams) WithDollarTop(dollarTop *string) *THSRAPIDailyTimetableParams {
	o.SetDollarTop(dollarTop)
	return o
}

// SetDollarTop adds the dollarTop to the t h s r Api daily timetable params
func (o *THSRAPIDailyTimetableParams) SetDollarTop(dollarTop *string) {
