...
func (o *THSRAPIDailyTrainInfo3Params) WithDollarTop(dollarTop *string) *THSRAPIDailyTrainInfo3Params {
	o.SetDollarTop(dollarTop)
	return o
}

// SetDollarTop adds the dollarTop to the t h s r Api daily train info 3 params
func (o *THSRAPIDailyTrainInfo3Params) SetDollarTop(dollarTop *string) {
