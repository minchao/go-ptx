...
func NewTHSRAPIDailyTrainInfo21233OK() *THSRAPIDailyTrainInfo21233OK {
	return &THSRAPIDailyTrainInfo21233OK{}
}
...
func (o *THSRAPIDailyTrainInfo21233OK) Error() string {
	return fmt.Sprintf("[GET /v2/Rail/THSR/DailyTrainInfo/TrainNo/{TrainNo}/TrainDate/{TrainDate}][%d] tHSRApiDailyTrainInfo21233OK  %+v", 200, o.Payload)
}
func (o *THSRAPIDailyTrainInfo21233OK) GetPayload() []*models.PTXServiceDTORailSpecificationV2THSRRailDailyTrainInfo {
	return o.Payload
}

func (o *THSRAPIDailyTrainInfo21233OK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *THSRAPIDailyTrainInfo21233Status299) Error() string {
	return fmt.Sprintf("[GET /v2/Rail/THSR/DailyTrainInfo/TrainNo/{TrainNo}/TrainDate/{TrainDate}][%d] tHSRApiDailyTrainInfo21233Status299  %+v", 299, o.Payload)
}
func (o *THSRAPIDailyTrainInfo21233Status299) GetPayload() *models.PTXServiceDTOSharedSpecificationV3BaseDisplayHealth {
	return o.Payload
}

func (o *THSRAPIDailyTrainInfo21233Status299) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func (o *THSRAPIDailyTrainInfo21233NotModified) Error() string {
	return fmt.Sprintf("[GET /v2/Rail/THSR/DailyTrainInfo/TrainNo/{TrainNo}/TrainDate/{TrainDate}][%d] tHSRApiDailyTrainInfo21233NotModified ", 304)
}

func (o *THSRAPIDailyTrainInfo21233NotModified) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
