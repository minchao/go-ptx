...
func (o *THSRAPIShape2129Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewTHSRAPIShape2129OK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 299:
		result := NewTHSRAPIShape2129Status299()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 304:
		result := NewTHSRAPIShape2129NotModified()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *THSRAPIShape2129OK) Error() string {
	return fmt.Sprintf("[GET /v2/Rail/THSR/Shape][%d] tHSRApiShape2129OK  %+v", 200, o.Payload)
}
func (o *THSRAPIShape2129OK) GetPayload() []*models.PTXServiceDTORailSpecificationV2THSRTHSRShape {
	return o.Payload
}

func (o *THSRAPIShape2129OK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewTHSRAPIShape2129Status299() *THSRAPIShape2129Status299 {
	return &THSRAPIShape2129Status299{}
}
...
func (o *THSRAPIShape2129Status299) Error() string {
	return fmt.Sprintf("[GET /v2/Rail/THSR/Shape][%d] tHSRApiShape2129Status299  %+v", 299, o.Payload)
}
func (o *THSRAPIShape2129Status299) GetPayload() *models.PTXServiceDTOSharedSpecificationV3BaseDisplayHealth {
	return o.Payload
}

func (o *THSRAPIShape2129Status299) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewTHSRAPIShape2129NotModified() *THSRAPIShape2129NotModified {
	return &THSRAPIShape2129NotModified{}
}
...
func (o *THSRAPIShape2129NotModified) Error() string {
	return fmt.Sprintf("[GET /v2/Rail/THSR/Shape][%d] tHSRApiShape2129NotModified ", 304)
}

func (o *THSRAPIShape2129NotModified) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
