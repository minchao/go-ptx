...
func (o *THSRAPIStationTimetableReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 299:
		result := NewTHSRAPIStationTimetableStatus299()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
...
func NewTHSRAPIStationTimetableStatus299() *THSRAPIStationTimetableStatus299 {
	return &THSRAPIStationTimetableStatus299{}
}
...
func (o *THSRAPIStationTimetableStatus299) Error() string {
	return fmt.Sprintf("[GET /v2/Rail/THSR/DailyTimetable/Station/{StationID}/{TrainDate}][%d] tHSRApiStationTimetableStatus299  %+v", 299, o.Payload)
}
func (o *THSRAPIStationTimetableStatus299) GetPayload() *models.PTXServiceDTOSharedSpecificationV3BaseDisplayHealth {
	return o.Payload
}

func (o *THSRAPIStationTimetableStatus299) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
