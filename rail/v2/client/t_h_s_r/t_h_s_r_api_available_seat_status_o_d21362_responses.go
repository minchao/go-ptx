...
func (o *THSRAPIAvailableSeatStatusOD21362Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewTHSRAPIAvailableSeatStatusOD21362OK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 299:
		result := NewTHSRAPIAvailableSeatStatusOD21362Status299()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 304:
		result := NewTHSRAPIAvailableSeatStatusOD21362NotModified()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func NewTHSRAPIAvailableSeatStatusOD21362OK() *THSRAPIAvailableSeatStatusOD21362OK {
	return &THSRAPIAvailableSeatStatusOD21362OK{}
}
...
func (o *THSRAPIAvailableSeatStatusOD21362OK) Error() string {
	return fmt.Sprintf("[GET /v2/Rail/THSR/AvailableSeatStatus/Train/OD/{OriginStationID}/to/{DestinationStationID}/TrainDate/{TrainDate}/TrainNo/{TrainNo}][%d] tHSRApiAvailableSeatStatusOD21362OK  %+v", 200, o.Payload)
}
func (o *THSRAPIAvailableSeatStatusOD21362OK) GetPayload() *models.PTXAPIRailModelV2THSRODAvailableSeatStatusWrapperPTXServiceDTORailSpecificationV2THSRODAvailableSeat {
	return o.Payload
}

func (o *THSRAPIAvailableSeatStatusOD21362OK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewTHSRAPIAvailableSeatStatusOD21362Status299() *THSRAPIAvailableSeatStatusOD21362Status299 {
	return &THSRAPIAvailableSeatStatusOD21362Status299{}
}
...
func (o *THSRAPIAvailableSeatStatusOD21362Status299) Error() string {
	return fmt.Sprintf("[GET /v2/Rail/THSR/AvailableSeatStatus/Train/OD/{OriginStationID}/to/{DestinationStationID}/TrainDate/{TrainDate}/TrainNo/{TrainNo}][%d] tHSRApiAvailableSeatStatusOD21362Status299  %+v", 299, o.Payload)
}
func (o *THSRAPIAvailableSeatStatusOD21362Status299) GetPayload() *models.PTXServiceDTOSharedSpecificationV3BaseDisplayHealth {
	return o.Payload
}

func (o *THSRAPIAvailableSeatStatusOD21362Status299) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewTHSRAPIAvailableSeatStatusOD21362NotModified() *THSRAPIAvailableSeatStatusOD21362NotModified {
	return &THSRAPIAvailableSeatStatusOD21362NotModified{}
}
...
func (o *THSRAPIAvailableSeatStatusOD21362NotModified) Error() string {
	return fmt.Sprintf("[GET /v2/Rail/THSR/AvailableSeatStatus/Train/OD/{OriginStationID}/to/{DestinationStationID}/TrainDate/{TrainDate}/TrainNo/{TrainNo}][%d] tHSRApiAvailableSeatStatusOD21362NotModified ", 304)
}

func (o *THSRAPIAvailableSeatStatusOD21362NotModified) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
