...
func (o *THSRAPIStation2120Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewTHSRAPIStation2120OK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 299:
		result := NewTHSRAPIStation2120Status299()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 304:
		result := NewTHSRAPIStation2120NotModified()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func (o *THSRAPIStation2120OK) Error() string {
	return fmt.Sprintf("[GET /v2/Rail/THSR/Station][%d] tHSRApiStation2120OK  %+v", 200, o.Payload)
}
func (o *THSRAPIStation2120OK) GetPayload() []*models.PTXServiceDTORailSpecificationV2THSRRailStation {
	return o.Payload
}

func (o *THSRAPIStation2120OK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewTHSRAPIStation2120Status299() *THSRAPIStation2120Status299 {
	return &THSRAPIStation2120Status299{}
}
...
func (o *THSRAPIStation2120Status299) Error() string {
	return fmt.Sprintf("[GET /v2/Rail/THSR/Station][%d] tHSRApiStation2120Status299  %+v", 299, o.Payload)
}
func (o *THSRAPIStation2120Status299) GetPayload() *models.PTXServiceDTOSharedSpecificationV3BaseDisplayHealth {
	return o.Payload
}

func (o *THSRAPIStation2120Status299) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewTHSRAPIStation2120NotModified() *THSRAPIStation2120NotModified {
	return &THSRAPIStation2120NotModified{}
}
...
func (o *THSRAPIStation2120NotModified) Error() string {
	return fmt.Sprintf("[GET /v2/Rail/THSR/Station][%d] tHSRApiStation2120NotModified ", 304)
}

func (o *THSRAPIStation2120NotModified) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
