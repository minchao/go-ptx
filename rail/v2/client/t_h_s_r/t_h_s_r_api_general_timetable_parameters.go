...
func (o *THSRAPIGeneralTimetableParams) WithDollarTop(dollarTop *string) *THSRAPIGeneralTimetableParams {
	o.SetDollarTop(dollarTop)
	return o
}

// SetDollarTop adds the dollarTop to the t h s r Api general timetable params
func (o *THSRAPIGeneralTimetableParams) SetDollarTop(dollarTop *string) {
