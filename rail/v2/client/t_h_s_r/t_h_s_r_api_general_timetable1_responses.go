...
func (o *THSRAPIGeneralTimetable1Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 299:
		result := NewTHSRAPIGeneralTimetable1Status299()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
...
func NewTHSRAPIGeneralTimetable1Status299() *THSRAPIGeneralTimetable1Status299 {
	return &THSRAPIGeneralTimetable1Status299{}
}
...
func (o *THSRAPIGeneralTimetable1Status299) Error() string {
	return fmt.Sprintf("[GET /v2/Rail/THSR/GeneralTimetable/TrainNo/{TrainNo}][%d] tHSRApiGeneralTimetable1Status299  %+v", 299, o.Payload)
}
func (o *THSRAPIGeneralTimetable1Status299) GetPayload() *models.PTXServiceDTOSharedSpecificationV3BaseDisplayHealth {
	return o.Payload
}

func (o *THSRAPIGeneralTimetable1Status299) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
