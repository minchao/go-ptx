...
func (o *THSRAPIDailyTimetable2124Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewTHSRAPIDailyTimetable2124OK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 299:
		result := NewTHSRAPIDailyTimetable2124Status299()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 304:
		result := NewTHSRAPIDailyTimetable2124NotModified()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func NewTHSRAPIDailyTimetable2124OK() *THSRAPIDailyTimetable2124OK {
	return &THSRAPIDailyTimetable2124OK{}
}
...
func (o *THSRAPIDailyTimetable2124OK) Error() string {
	return fmt.Sprintf("[GET /v2/Rail/THSR/DailyTimetable/Today][%d] tHSRApiDailyTimetable2124OK  %+v", 200, o.Payload)
}
func (o *THSRAPIDailyTimetable2124OK) GetPayload() []*models.PTXServiceDTORailSpecificationV2THSRRailDailyTimetable {
	return o.Payload
}

func (o *THSRAPIDailyTimetable2124OK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewTHSRAPIDailyTimetable2124Status299() *THSRAPIDailyTimetable2124Status299 {
	return &THSRAPIDailyTimetable2124Status299{}
}
...
func (o *THSRAPIDailyTimetable2124Status299) Error() string {
	return fmt.Sprintf("[GET /v2/Rail/THSR/DailyTimetable/Today][%d] tHSRApiDailyTimetable2124Status299  %+v", 299, o.Payload)
}
func (o *THSRAPIDailyTimetable2124Status299) GetPayload() *models.PTXServiceDTOSharedSpecificationV3BaseDisplayHealth {
	return o.Payload
}

func (o *THSRAPIDailyTimetable2124Status299) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewTHSRAPIDailyTimetable2124NotModified() *THSRAPIDailyTimetable2124NotModified {
	return &THSRAPIDailyTimetable2124NotModified{}
}
...
func (o *THSRAPIDailyTimetable2124NotModified) Error() string {
	return fmt.Sprintf("[GET /v2/Rail/THSR/DailyTimetable/Today][%d] tHSRApiDailyTimetable2124NotModified ", 304)
}

func (o *THSRAPIDailyTimetable2124NotModified) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
