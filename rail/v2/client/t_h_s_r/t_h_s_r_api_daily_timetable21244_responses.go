...
func (o *THSRAPIDailyTimetable21244Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewTHSRAPIDailyTimetable21244OK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 299:
		result := NewTHSRAPIDailyTimetable21244Status299()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 304:
		result := NewTHSRAPIDailyTimetable21244NotModified()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func NewTHSRAPIDailyTimetable21244OK() *THSRAPIDailyTimetable21244OK {
	return &THSRAPIDailyTimetable21244OK{}
}
...
func (o *THSRAPIDailyTimetable21244OK) Error() string {
	return fmt.Sprintf("[GET /v2/Rail/THSR/DailyTimetable/TrainNo/{TrainNo}/TrainDate/{TrainDate}][%d] tHSRApiDailyTimetable21244OK  %+v", 200, o.Payload)
}
func (o *THSRAPIDailyTimetable21244OK) GetPayload() []*models.PTXServiceDTORailSpecificationV2THSRRailDailyTimetable {
	return o.Payload
}

func (o *THSRAPIDailyTimetable21244OK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewTHSRAPIDailyTimetable21244Status299() *THSRAPIDailyTimetable21244Status299 {
	return &THSRAPIDailyTimetable21244Status299{}
}
...
func (o *THSRAPIDailyTimetable21244Status299) Error() string {
	return fmt.Sprintf("[GET /v2/Rail/THSR/DailyTimetable/TrainNo/{TrainNo}/TrainDate/{TrainDate}][%d] tHSRApiDailyTimetable21244Status299  %+v", 299, o.Payload)
}
func (o *THSRAPIDailyTimetable21244Status299) GetPayload() *models.PTXServiceDTOSharedSpecificationV3BaseDisplayHealth {
	return o.Payload
}

func (o *THSRAPIDailyTimetable21244Status299) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewTHSRAPIDailyTimetable21244NotModified() *THSRAPIDailyTimetable21244NotModified {
	return &THSRAPIDailyTimetable21244NotModified{}
}
...
func (o *THSRAPIDailyTimetable21244NotModified) Error() string {
	return fmt.Sprintf("[GET /v2/Rail/THSR/DailyTimetable/TrainNo/{TrainNo}/TrainDate/{TrainDate}][%d] tHSRApiDailyTimetable21244NotModified ", 304)
}

func (o *THSRAPIDailyTimetable21244NotModified) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
