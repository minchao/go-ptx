...
func (o *THSRAPIDailyTrainInfo21231Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewTHSRAPIDailyTrainInfo21231OK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 299:
		result := NewTHSRAPIDailyTrainInfo21231Status299()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 304:
		result := NewTHSRAPIDailyTrainInfo21231NotModified()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func NewTHSRAPIDailyTrainInfo21231OK() *THSRAPIDailyTrainInfo21231OK {
	return &THSRAPIDailyTrainInfo21231OK{}
}
...
func (o *THSRAPIDailyTrainInfo21231OK) Error() string {
	return fmt.Sprintf("[GET /v2/Rail/THSR/DailyTrainInfo/Today/TrainNo/{TrainNo}][%d] tHSRApiDailyTrainInfo21231OK  %+v", 200, o.Payload)
}
func (o *THSRAPIDailyTrainInfo21231OK) GetPayload() []*models.PTXServiceDTORailSpecificationV2THSRRailDailyTrainInfo {
	return o.Payload
}

func (o *THSRAPIDailyTrainInfo21231OK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewTHSRAPIDailyTrainInfo21231Status299() *THSRAPIDailyTrainInfo21231Status299 {
	return &THSRAPIDailyTrainInfo21231Status299{}
}
...
func (o *THSRAPIDailyTrainInfo21231Status299) Error() string {
	return fmt.Sprintf("[GET /v2/Rail/THSR/DailyTrainInfo/Today/TrainNo/{TrainNo}][%d] tHSRApiDailyTrainInfo21231Status299  %+v", 299, o.Payload)
}
func (o *THSRAPIDailyTrainInfo21231Status299) GetPayload() *models.PTXServiceDTOSharedSpecificationV3BaseDisplayHealth {
	return o.Payload
}

func (o *THSRAPIDailyTrainInfo21231Status299) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewTHSRAPIDailyTrainInfo21231NotModified() *THSRAPIDailyTrainInfo21231NotModified {
	return &THSRAPIDailyTrainInfo21231NotModified{}
}
...
func (o *THSRAPIDailyTrainInfo21231NotModified) Error() string {
	return fmt.Sprintf("[GET /v2/Rail/THSR/DailyTrainInfo/Today/TrainNo/{TrainNo}][%d] tHSRApiDailyTrainInfo21231NotModified ", 304)
}

func (o *THSRAPIDailyTrainInfo21231NotModified) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
