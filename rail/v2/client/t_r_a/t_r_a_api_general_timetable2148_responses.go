...
func (o *TRAAPIGeneralTimetable2148Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewTRAAPIGeneralTimetable2148OK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 299:
		result := NewTRAAPIGeneralTimetable2148Status299()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 304:
		result := NewTRAAPIGeneralTimetable2148NotModified()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func NewTRAAPIGeneralTimetable2148OK() *TRAAPIGeneralTimetable2148OK {
	return &TRAAPIGeneralTimetable2148OK{}
}
...
func (o *TRAAPIGeneralTimetable2148OK) Error() string {
	return fmt.Sprintf("[GET /v2/Rail/TRA/GeneralTimetable][%d] tRAApiGeneralTimetable2148OK  %+v", 200, o.Payload)
}
func (o *TRAAPIGeneralTimetable2148OK) GetPayload() []*models.PTXServiceDTORailSpecificationV2TRARailGeneralTimetable {
	return o.Payload
}

func (o *TRAAPIGeneralTimetable2148OK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewTRAAPIGeneralTimetable2148Status299() *TRAAPIGeneralTimetable2148Status299 {
	return &TRAAPIGeneralTimetable2148Status299{}
}
...
func (o *TRAAPIGeneralTimetable2148Status299) Error() string {
	return fmt.Sprintf("[GET /v2/Rail/TRA/GeneralTimetable][%d] tRAApiGeneralTimetable2148Status299  %+v", 299, o.Payload)
}
func (o *TRAAPIGeneralTimetable2148Status299) GetPayload() *models.PTXServiceDTOSharedSpecificationV3BaseDisplayHealth {
	return o.Payload
}

func (o *TRAAPIGeneralTimetable2148Status299) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewTRAAPIGeneralTimetable2148NotModified() *TRAAPIGeneralTimetable2148NotModified {
	return &TRAAPIGeneralTimetable2148NotModified{}
}
...
func (o *TRAAPIGeneralTimetable2148NotModified) Error() string {
	return fmt.Sprintf("[GET /v2/Rail/TRA/GeneralTimetable][%d] tRAApiGeneralTimetable2148NotModified ", 304)
}

func (o *TRAAPIGeneralTimetable2148NotModified) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
