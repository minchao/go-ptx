...
func (o *TRAAPIDailyTrainInfo3Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 299:
		result := NewTRAAPIDailyTrainInfo3Status299()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
...
// NewTRAAPIDailyTrainInfo3Status299 creates a TRAAPIDailyTrainInfo3Status299 with default headers values
func NewTRAAPIDailyTrainInfo3Status299() *TRAAPIDailyTrainInfo3Status299 {
	return &TRAAPIDailyTrainInfo3Status299{}
}

/* TRAAPIDailyTrainInfo3Status299 describes a response with status code 299, with default header values.

加入參數'?health=true'即可查詢此API服務的健康狀態
*/
type TRAAPIDailyTrainInfo3Status299 struct {
	Payload *models.PTXServiceDTOSharedSpecificationV3BaseDisplayHealth
}

func (o *TRAAPIDailyTrainInfo3Status299) Error() string {
	return fmt.Sprintf("[GET /v2/Rail/TRA/DailyTrainInfo/TrainNo/{TrainNo}/TrainDate/{TrainDate}][%d] tRAApiDailyTrainInfo3Status299  %+v", 299, o.Payload)
}
func (o *TRAAPIDailyTrainInfo3Status299) GetPayload() *models.PTXServiceDTOSharedSpecificationV3BaseDisplayHealth {
	return o.Payload
}

func (o *TRAAPIDailyTrainInfo3Status299) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
