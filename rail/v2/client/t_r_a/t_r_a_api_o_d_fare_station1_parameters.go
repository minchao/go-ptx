...
func (o *TRAAPIODFareStation1Params) WithDollarTop(dollarTop *string) *TRAAPIODFareStation1Params {
	o.SetDollarTop(dollarTop)
	return o
}

// SetDollarTop adds the dollarTop to the t r a Api o d fare station 1 params
func (o *TRAAPIODFareStation1Params) SetDollarTop(dollarTop *string) {
