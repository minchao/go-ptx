...
// WithHealth adds the health to the t r a Api o d fare station 1 params
func (o *TRAAPIODFareStation1Params) WithHealth(health *string) *TRAAPIODFareStation1Params {
	o.SetHealth(health)
	return o
}

// SetHealth adds the health to the t r a Api o d fare station 1 params
func (o *TRAAPIODFareStation1Params) SetHealth(health *string) {
	o.Health = health
}
