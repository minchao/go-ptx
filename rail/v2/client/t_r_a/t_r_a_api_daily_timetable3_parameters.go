...
func (o *TRAAPIDailyTimetable3Params) WithDollarTop(dollarTop *string) *TRAAPIDailyTimetable3Params {
	o.SetDollarTop(dollarTop)
	return o
}

// SetDollarTop adds the dollarTop to the t r a Api daily timetable 3 params
func (o *TRAAPIDailyTimetable3Params) SetDollarTop(dollarTop *string) {
