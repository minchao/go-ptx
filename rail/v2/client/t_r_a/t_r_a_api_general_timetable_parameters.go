...
// WithHealth adds the health to the t r a Api general timetable params
func (o *TRAAPIGeneralTimetableParams) WithHealth(health *string) *TRAAPIGeneralTimetableParams {
	o.SetHealth(health)
	return o
}

// SetHealth adds the health to the t r a Api general timetable params
func (o *TRAAPIGeneralTimetableParams) SetHealth(health *string) {
	o.Health = health
}
