...
// WithHealth adds the health to the t r a Api o d daily timetable params
func (o *TRAAPIODDailyTimetableParams) WithHealth(health *string) *TRAAPIODDailyTimetableParams {
	o.SetHealth(health)
	return o
}

// SetHealth adds the health to the t r a Api o d daily timetable params
func (o *TRAAPIODDailyTimetableParams) SetHealth(health *string) {
	o.Health = health
}
