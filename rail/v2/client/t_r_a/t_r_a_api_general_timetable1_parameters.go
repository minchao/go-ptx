...
// WithHealth adds the health to the t r a Api general timetable 1 params
func (o *TRAAPIGeneralTimetable1Params) WithHealth(health *string) *TRAAPIGeneralTimetable1Params {
	o.SetHealth(health)
	return o
}

// SetHealth adds the health to the t r a Api general timetable 1 params
func (o *TRAAPIGeneralTimetable1Params) SetHealth(health *string) {
	o.Health = health
}
