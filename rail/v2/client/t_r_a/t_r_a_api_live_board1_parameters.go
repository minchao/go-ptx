...
func (o *TRAAPILiveBoard1Params) WithDollarTop(dollarTop *int64) *TRAAPILiveBoard1Params {
	o.SetDollarTop(dollarTop)
	return o
}

// SetDollarTop adds the dollarTop to the t r a Api live board 1 params
func (o *TRAAPILiveBoard1Params) SetDollarTop(dollarTop *int64) {
...
// WithHealth adds the health to the t r a Api live board 1 params
func (o *TRAAPILiveBoard1Params) WithHealth(health *string) *TRAAPILiveBoard1Params {
	o.SetHealth(health)
	return o
}

// SetHealth adds the health to the t r a Api live board 1 params
func (o *TRAAPILiveBoard1Params) SetHealth(health *string) {
	o.Health = health
}
