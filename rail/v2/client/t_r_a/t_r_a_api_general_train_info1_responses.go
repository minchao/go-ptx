...
func (o *TRAAPIGeneralTrainInfo1Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 299:
		result := NewTRAAPIGeneralTrainInfo1Status299()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
...
// NewTRAAPIGeneralTrainInfo1Status299 creates a TRAAPIGeneralTrainInfo1Status299 with default headers values
func NewTRAAPIGeneralTrainInfo1Status299() *TRAAPIGeneralTrainInfo1Status299 {
	return &TRAAPIGeneralTrainInfo1Status299{}
}

/* TRAAPIGeneralTrainInfo1Status299 describes a response with status code 299, with default header values.

加入參數'?health=true'即可查詢此API服務的健康狀態
*/
type TRAAPIGeneralTrainInfo1Status299 struct {
	Payload *models.PTXServiceDTOSharedSpecificationV3BaseDisplayHealth
}

func (o *TRAAPIGeneralTrainInfo1Status299) Error() string {
	return fmt.Sprintf("[GET /v2/Rail/TRA/GeneralTrainInfo/TrainNo/{TrainNo}][%d] tRAApiGeneralTrainInfo1Status299  %+v", 299, o.Payload)
}
func (o *TRAAPIGeneralTrainInfo1Status299) GetPayload() *models.PTXServiceDTOSharedSpecificationV3BaseDisplayHealth {
	return o.Payload
}

func (o *TRAAPIGeneralTrainInfo1Status299) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
