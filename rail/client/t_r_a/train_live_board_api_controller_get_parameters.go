...
func (o *TrainLiveBoardAPIControllerGetParams) WithDollarTop(dollarTop *string) *TrainLiveBoardAPIControllerGetParams {
	o.SetDollarTop(dollarTop)
	return o
}

// SetDollarTop adds the dollarTop to the train live board Api controller get params
func (o *TrainLiveBoardAPIControllerGetParams) SetDollarTop(dollarTop *string) {
