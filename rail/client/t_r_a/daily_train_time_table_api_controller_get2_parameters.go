...
func (o *DailyTrainTimeTableAPIControllerGet2Params) WithDollarTop(dollarTop *string) *DailyTrainTimeTableAPIControllerGet2Params {
	o.SetDollarTop(dollarTop)
	return o
}

// SetDollarTop adds the dollarTop to the daily train time table Api controller get 2 params
func (o *DailyTrainTimeTableAPIControllerGet2Params) SetDollarTop(dollarTop *string) {
	o.DollarTop = dollarTop
}

// WithTrainDate adds the trainDate to the daily train time table Api controller get 2 params
func (o *DailyTrainTimeTableAPIControllerGet2Params) WithTrainDate(trainDate string) *DailyTrainTimeTableAPIControllerGet2Params {
