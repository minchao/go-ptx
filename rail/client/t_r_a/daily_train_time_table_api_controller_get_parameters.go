...
func (o *DailyTrainTimeTableAPIControllerGetParams) WithDollarTop(dollarTop *string) *DailyTrainTimeTableAPIControllerGetParams {
	o.SetDollarTop(dollarTop)
	return o
}

// SetDollarTop adds the dollarTop to the daily train time table Api controller get params
func (o *DailyTrainTimeTableAPIControllerGetParams) SetDollarTop(dollarTop *string) {
