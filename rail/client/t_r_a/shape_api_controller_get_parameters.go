...
func (o *ShapeAPIControllerGetParams) WithDollarTop(dollarTop *string) *ShapeAPIControllerGetParams {
	o.SetDollarTop(dollarTop)
	return o
}

// SetDollarTop adds the dollarTop to the shape Api controller get params
func (o *ShapeAPIControllerGetParams) SetDollarTop(dollarTop *string) {
