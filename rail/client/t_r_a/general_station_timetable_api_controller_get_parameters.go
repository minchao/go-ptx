...
func (o *GeneralStationTimetableAPIControllerGetParams) WithDollarTop(dollarTop *string) *GeneralStationTimetableAPIControllerGetParams {
	o.SetDollarTop(dollarTop)
	return o
}

// SetDollarTop adds the dollarTop to the general station timetable Api controller get params
func (o *GeneralStationTimetableAPIControllerGetParams) SetDollarTop(dollarTop *string) {
