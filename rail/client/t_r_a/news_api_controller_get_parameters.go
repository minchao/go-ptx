...
func (o *NewsAPIControllerGetParams) WithDollarTop(dollarTop *string) *NewsAPIControllerGetParams {
	o.SetDollarTop(dollarTop)
	return o
}

// SetDollarTop adds the dollarTop to the news Api controller get params
func (o *NewsAPIControllerGetParams) SetDollarTop(dollarTop *string) {
