...
Success
*/
type LiteTrainODFare1OK struct {
...
func (o *LiteTrainODFare1OK) Error() string {
	return fmt.Sprintf("[GET /v3/Rail/AFR/ODFare/{OriginStationID}/to/{DestinationStationID}][%d] liteTrainODFare1OK  %+v", 200, o.Payload)
}
func (o *LiteTrainODFare1OK) GetPayload() *models.PTXAPIRailModelLiteTrainLiteTrainODFareWrapperPTXServiceDTORailSpecificationV3LiteTrainODFareODFare {
	return o.Payload
}
...
func NewLiteTrainODFare1NotModified() *LiteTrainODFare1NotModified {
	return &LiteTrainODFare1NotModified{}
}
...
func (o *LiteTrainODFare1NotModified) Error() string {
	return fmt.Sprintf("[GET /v3/Rail/AFR/ODFare/{OriginStationID}/to/{DestinationStationID}][%d] liteTrainODFare1NotModified ", 304)
}

func (o *LiteTrainODFare1NotModified) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
