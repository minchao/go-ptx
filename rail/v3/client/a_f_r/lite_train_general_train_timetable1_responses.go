...
func (o *LiteTrainGeneralTrainTimetable1Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewLiteTrainGeneralTrainTimetable1OK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 299:
		result := NewLiteTrainGeneralTrainTimetable1Status299()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 304:
		result := NewLiteTrainGeneralTrainTimetable1NotModified()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func NewLiteTrainGeneralTrainTimetable1OK() *LiteTrainGeneralTrainTimetable1OK {
	return &LiteTrainGeneralTrainTimetable1OK{}
}
...
Success
*/
type LiteTrainGeneralTrainTimetable1OK struct {
...
func (o *LiteTrainGeneralTrainTimetable1OK) Error() string {
	return fmt.Sprintf("[GET /v3/Rail/AFR/GeneralTrainTimetable/TrainNo/{TrainNo}][%d] liteTrainGeneralTrainTimetable1OK  %+v", 200, o.Payload)
}
func (o *LiteTrainGeneralTrainTimetable1OK) GetPayload() *models.PTXAPIRailModelLiteTrainLiteTrainGeneralTrainWrapperPTXServiceDTORailSpecificationV3LiteTrainGeneralTrainTimetable {
	return o.Payload
}

func (o *LiteTrainGeneralTrainTimetable1OK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewLiteTrainGeneralTrainTimetable1Status299() *LiteTrainGeneralTrainTimetable1Status299 {
	return &LiteTrainGeneralTrainTimetable1Status299{}
}
...
func (o *LiteTrainGeneralTrainTimetable1Status299) Error() string {
	return fmt.Sprintf("[GET /v3/Rail/AFR/GeneralTrainTimetable/TrainNo/{TrainNo}][%d] liteTrainGeneralTrainTimetable1Status299  %+v", 299, o.Payload)
}
func (o *LiteTrainGeneralTrainTimetable1Status299) GetPayload() *models.PTXServiceDTOSharedSpecificationV3BaseDisplayHealth {
	return o.Payload
}

func (o *LiteTrainGeneralTrainTimetable1Status299) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewLiteTrainGeneralTrainTimetable1NotModified() *LiteTrainGeneralTrainTimetable1NotModified {
	return &LiteTrainGeneralTrainTimetable1NotModified{}
}
...
func (o *LiteTrainGeneralTrainTimetable1NotModified) Error() string {
	return fmt.Sprintf("[GET /v3/Rail/AFR/GeneralTrainTimetable/TrainNo/{TrainNo}][%d] liteTrainGeneralTrainTimetable1NotModified ", 304)
}

func (o *LiteTrainGeneralTrainTimetable1NotModified) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
