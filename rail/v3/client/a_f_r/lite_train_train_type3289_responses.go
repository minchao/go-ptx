...
func (o *LiteTrainTrainType3289Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 299:
		...
		return result, nil
	case 304:
		result := NewLiteTrainTrainType3289NotModified()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func NewLiteTrainTrainType3289NotModified() *LiteTrainTrainType3289NotModified {
	return &LiteTrainTrainType3289NotModified{}
}
...
func (o *LiteTrainTrainType3289NotModified) Error() string {
	return fmt.Sprintf("[GET /v3/Rail/AFR/TrainType][%d] liteTrainTrainType3289NotModified ", 304)
}

func (o *LiteTrainTrainType3289NotModified) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
