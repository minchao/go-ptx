...
func (o *LiteTrainLine3283Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 299:
		...
		return result, nil
	case 304:
		result := NewLiteTrainLine3283NotModified()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func NewLiteTrainLine3283NotModified() *LiteTrainLine3283NotModified {
	return &LiteTrainLine3283NotModified{}
}
...
func (o *LiteTrainLine3283NotModified) Error() string {
	return fmt.Sprintf("[GET /v3/Rail/AFR/Line][%d] liteTrainLine3283NotModified ", 304)
}

func (o *LiteTrainLine3283NotModified) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
