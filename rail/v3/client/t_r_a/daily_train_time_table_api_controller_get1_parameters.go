...
func (o *DailyTrainTimeTableAPIControllerGet1Params) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the daily train time table Api controller get 1 params
func (o *DailyTrainTimeTableAPIControllerGet1Params) WithContext(ctx context.Context) *DailyTrainTimeTableAPIControllerGet1Params {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the daily train time table Api controller get 1 params
func (o *DailyTrainTimeTableAPIControllerGet1Params) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the daily train time table Api controller get 1 params
func (o *DailyTrainTimeTableAPIControllerGet1Params) WithHTTPClient(client *http.Client) *DailyTrainTimeTableAPIControllerGet1Params {
...
func (o *DailyTrainTimeTableAPIControllerGet1Params) WithDollarFilter(dollarFilter *string) *DailyTrainTimeTableAPIControllerGet1Params {
...
func (o *DailyTrainTimeTableAPIControllerGet1Params) WithDollarFormat(dollarFormat string) *DailyTrainTimeTableAPIControllerGet1Params {
...
func (o *DailyTrainTimeTableAPIControllerGet1Params) WithDollarOrderby(dollarOrderby *string) *DailyTrainTimeTableAPIControllerGet1Params {
...
func (o *DailyTrainTimeTableAPIControllerGet1Params) WithDollarSelect(dollarSelect *string) *DailyTrainTimeTableAPIControllerGet1Params {
...
func (o *DailyTrainTimeTableAPIControllerGet1Params) WithDollarSkip(dollarSkip *string) *DailyTrainTimeTableAPIControllerGet1Params {
...
func (o *DailyTrainTimeTableAPIControllerGet1Params) WithDollarTop(dollarTop *int64) *DailyTrainTimeTableAPIControllerGet1Params {
...
func (o *DailyTrainTimeTableAPIControllerGet1Params) WithTrainNo(trainNo string) *DailyTrainTimeTableAPIControllerGet1Params {
...
func (o *DailyTrainTimeTableAPIControllerGet1Params) WithHealth(health *string) *DailyTrainTimeTableAPIControllerGet1Params {
	o.SetHealth(health)
	return o
}
...
func (o *DailyTrainTimeTableAPIControllerGet1Params) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
