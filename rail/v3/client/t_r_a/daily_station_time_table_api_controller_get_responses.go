...
func (o *DailyStationTimeTableAPIControllerGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 299:
		result := NewDailyStationTimeTableAPIControllerGetStatus299()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
...
func NewDailyStationTimeTableAPIControllerGetStatus299() *DailyStationTimeTableAPIControllerGetStatus299 {
	return &DailyStationTimeTableAPIControllerGetStatus299{}
}
...
func (o *DailyStationTimeTableAPIControllerGetStatus299) Error() string {
	return fmt.Sprintf("[GET /v3/Rail/TRA/DailyStationTimetable/Today][%d] dailyStationTimeTableApiControllerGetStatus299  %+v", 299, o.Payload)
}
func (o *DailyStationTimeTableAPIControllerGetStatus299) GetPayload() *models.PTXServiceDTOSharedSpecificationV3BaseDisplayHealth {
	return o.Payload
}

func (o *DailyStationTimeTableAPIControllerGetStatus299) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
