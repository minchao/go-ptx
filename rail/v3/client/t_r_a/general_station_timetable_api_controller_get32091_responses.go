...
func (o *GeneralStationTimetableAPIControllerGet32091Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 299:
		...
		return result, nil
	case 304:
		result := NewGeneralStationTimetableAPIControllerGet32091NotModified()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func NewGeneralStationTimetableAPIControllerGet32091NotModified() *GeneralStationTimetableAPIControllerGet32091NotModified {
	return &GeneralStationTimetableAPIControllerGet32091NotModified{}
}
...
func (o *GeneralStationTimetableAPIControllerGet32091NotModified) Error() string {
	return fmt.Sprintf("[GET /v3/Rail/TRA/GeneralStationTimetable/Station/{StationID}][%d] generalStationTimetableApiControllerGet32091NotModified ", 304)
}

func (o *GeneralStationTimetableAPIControllerGet32091NotModified) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
