...
func (o *StationLiveBoardAPIControllerGetParams) WithDollarTop(dollarTop *string) *StationLiveBoardAPIControllerGetParams {
	o.SetDollarTop(dollarTop)
	return o
}

// SetDollarTop adds the dollarTop to the station live board Api controller get params
func (o *StationLiveBoardAPIControllerGetParams) SetDollarTop(dollarTop *string) {
