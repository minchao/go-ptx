...
func (o *SpecificTrainTimetableAPIControllerGet1Params) WithHealth(health *string) *SpecificTrainTimetableAPIControllerGet1Params {
	o.SetHealth(health)
	return o
}

// SetHealth adds the health to the specific train timetable Api controller get 1 params
func (o *SpecificTrainTimetableAPIControllerGet1Params) SetHealth(health *string) {
	o.Health = health
}
