...
func (o *TrainLiveBoardAPIControllerGet1Params) WithDollarTop(dollarTop *int64) *TrainLiveBoardAPIControllerGet1Params {
...
func (o *TrainLiveBoardAPIControllerGet1Params) WithHealth(health *string) *TrainLiveBoardAPIControllerGet1Params {
	o.SetHealth(health)
	return o
}
