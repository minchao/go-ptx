...
func (o *GeneralStationTimetableAPIControllerGetParams) WithHealth(health *string) *GeneralStationTimetableAPIControllerGetParams {
	o.SetHealth(health)
	return o
}

// SetHealth adds the health to the general station timetable Api controller get params
func (o *GeneralStationTimetableAPIControllerGetParams) SetHealth(health *string) {
	o.Health = health
}
