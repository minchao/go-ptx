...
func (o *DailyStationTimeTableAPIControllerGet2Params) SetTrainDate(trainDate strfmt.DateTime) {
	o.TrainDate = trainDate
}

// WithHealth adds the health to the daily station time table Api controller get 2 params
func (o *DailyStationTimeTableAPIControllerGet2Params) WithHealth(health *string) *DailyStationTimeTableAPIControllerGet2Params {
	o.SetHealth(health)
	return o
}

// SetHealth adds the health to the daily station time table Api controller get 2 params
func (o *DailyStationTimeTableAPIControllerGet2Params) SetHealth(health *string) {
	o.Health = health
}
