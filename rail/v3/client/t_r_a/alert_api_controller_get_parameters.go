...
func (o *AlertAPIControllerGetParams) WithContext(ctx context.Context) *AlertAPIControllerGetParams {
	o.SetContext(ctx)
	return o
}
...
func (o *AlertAPIControllerGetParams) WithHTTPClient(client *http.Client) *AlertAPIControllerGetParams {
...
func (o *AlertAPIControllerGetParams) WithHealth(health *string) *AlertAPIControllerGetParams {
	o.SetHealth(health)
	return o
}
...
func (o *AlertAPIControllerGetParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
