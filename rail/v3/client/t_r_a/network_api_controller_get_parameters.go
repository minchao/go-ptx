...
func (o *NetworkAPIControllerGetParams) WithDollarTop(dollarTop *string) *NetworkAPIControllerGetParams {
	o.SetDollarTop(dollarTop)
	return o
}

// SetDollarTop adds the dollarTop to the network Api controller get params
func (o *NetworkAPIControllerGetParams) SetDollarTop(dollarTop *string) {
