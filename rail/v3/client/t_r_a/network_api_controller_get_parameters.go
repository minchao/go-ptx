...
func (o *NetworkAPIControllerGetParams) WithContext(ctx context.Context) *NetworkAPIControllerGetParams {
	o.SetContext(ctx)
	return o
}
...
func (o *NetworkAPIControllerGetParams) WithHTTPClient(client *http.Client) *NetworkAPIControllerGetParams {
...
func (o *NetworkAPIControllerGetParams) WithDollarTop(dollarTop *int64) *NetworkAPIControllerGetParams {
...
func (o *NetworkAPIControllerGetParams) WithHealth(health *string) *NetworkAPIControllerGetParams {
	o.SetHealth(health)
	return o
}
...
func (o *NetworkAPIControllerGetParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
