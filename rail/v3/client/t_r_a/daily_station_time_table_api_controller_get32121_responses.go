...
func (o *DailyStationTimeTableAPIControllerGet32121Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 299:
		...
		return result, nil
	case 304:
		result := NewDailyStationTimeTableAPIControllerGet32121NotModified()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func NewDailyStationTimeTableAPIControllerGet32121NotModified() *DailyStationTimeTableAPIControllerGet32121NotModified {
	return &DailyStationTimeTableAPIControllerGet32121NotModified{}
}
...
func (o *DailyStationTimeTableAPIControllerGet32121NotModified) Error() string {
	return fmt.Sprintf("[GET /v3/Rail/TRA/DailyStationTimetable/Today/Station/{StationID}][%d] dailyStationTimeTableApiControllerGet32121NotModified ", 304)
}

func (o *DailyStationTimeTableAPIControllerGet32121NotModified) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
