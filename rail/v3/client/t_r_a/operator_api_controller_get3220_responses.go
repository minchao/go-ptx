...
func (o *OperatorAPIControllerGet3220Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 299:
		...
		return result, nil
	case 304:
		result := NewOperatorAPIControllerGet3220NotModified()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func NewOperatorAPIControllerGet3220NotModified() *OperatorAPIControllerGet3220NotModified {
	return &OperatorAPIControllerGet3220NotModified{}
}
...
func (o *OperatorAPIControllerGet3220NotModified) Error() string {
	return fmt.Sprintf("[GET /v3/Rail/TRA/Operator][%d] operatorApiControllerGet3220NotModified ", 304)
}

func (o *OperatorAPIControllerGet3220NotModified) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
