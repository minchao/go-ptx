...
func (o *StationFacilityAPIControllerGet3203Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 299:
		...
		return result, nil
	case 304:
		result := NewStationFacilityAPIControllerGet3203NotModified()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func NewStationFacilityAPIControllerGet3203NotModified() *StationFacilityAPIControllerGet3203NotModified {
	return &StationFacilityAPIControllerGet3203NotModified{}
}
...
func (o *StationFacilityAPIControllerGet3203NotModified) Error() string {
	return fmt.Sprintf("[GET /v3/Rail/TRA/StationFacility][%d] stationFacilityApiControllerGet3203NotModified ", 304)
}

func (o *StationFacilityAPIControllerGet3203NotModified) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
