...
func (o *DailyTrainTimeTableAPIControllerGet1Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 299:
		result := NewDailyTrainTimeTableAPIControllerGet1Status299()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
...
func NewDailyTrainTimeTableAPIControllerGet1Status299() *DailyTrainTimeTableAPIControllerGet1Status299 {
	return &DailyTrainTimeTableAPIControllerGet1Status299{}
}
...
func (o *DailyTrainTimeTableAPIControllerGet1Status299) Error() string {
	return fmt.Sprintf("[GET /v3/Rail/TRA/DailyTrainTimetable/Today/TrainNo/{TrainNo}][%d] dailyTrainTimeTableApiControllerGet1Status299  %+v", 299, o.Payload)
}
func (o *DailyTrainTimeTableAPIControllerGet1Status299) GetPayload() *models.PTXServiceDTOSharedSpecificationV3BaseDisplayHealth {
	return o.Payload
}

func (o *DailyTrainTimeTableAPIControllerGet1Status299) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
