...
func (o *DailyStationTimeTableAPIControllerGet3212Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 299:
		...
		return result, nil
	case 304:
		result := NewDailyStationTimeTableAPIControllerGet3212NotModified()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func NewDailyStationTimeTableAPIControllerGet3212NotModified() *DailyStationTimeTableAPIControllerGet3212NotModified {
	return &DailyStationTimeTableAPIControllerGet3212NotModified{}
}
...
func (o *DailyStationTimeTableAPIControllerGet3212NotModified) Error() string {
	return fmt.Sprintf("[GET /v3/Rail/TRA/DailyStationTimetable/Today][%d] dailyStationTimeTableApiControllerGet3212NotModified ", 304)
}

func (o *DailyStationTimeTableAPIControllerGet3212NotModified) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
