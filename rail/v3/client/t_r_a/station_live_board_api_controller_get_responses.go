...
func (o *StationLiveBoardAPIControllerGetReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 299:
		result := NewStationLiveBoardAPIControllerGetStatus299()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
...
func NewStationLiveBoardAPIControllerGetStatus299() *StationLiveBoardAPIControllerGetStatus299 {
	return &StationLiveBoardAPIControllerGetStatus299{}
}
...
func (o *StationLiveBoardAPIControllerGetStatus299) Error() string {
	return fmt.Sprintf("[GET /v3/Rail/TRA/StationLiveBoard][%d] stationLiveBoardApiControllerGetStatus299  %+v", 299, o.Payload)
}
func (o *StationLiveBoardAPIControllerGetStatus299) GetPayload() *models.PTXServiceDTOSharedSpecificationV3BaseDisplayHealth {
	return o.Payload
}

func (o *StationLiveBoardAPIControllerGetStatus299) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
