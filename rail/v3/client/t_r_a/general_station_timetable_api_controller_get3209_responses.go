...
func (o *GeneralStationTimetableAPIControllerGet3209Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGeneralStationTimetableAPIControllerGet3209OK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 299:
		result := NewGeneralStationTimetableAPIControllerGet3209Status299()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 304:
		result := NewGeneralStationTimetableAPIControllerGet3209NotModified()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func NewGeneralStationTimetableAPIControllerGet3209OK() *GeneralStationTimetableAPIControllerGet3209OK {
	return &GeneralStationTimetableAPIControllerGet3209OK{}
}
...
Success
*/
type GeneralStationTimetableAPIControllerGet3209OK struct {
...
func (o *GeneralStationTimetableAPIControllerGet3209OK) Error() string {
	return fmt.Sprintf("[GET /v3/Rail/TRA/GeneralStationTimetable][%d] generalStationTimetableApiControllerGet3209OK  %+v", 200, o.Payload)
}
func (o *GeneralStationTimetableAPIControllerGet3209OK) GetPayload() *models.PTXAPIRailModelTRAGeneralStationWrapperPTXServiceDTORailSpecificationV3TRAGeneralStationTimetableGeneralStationTimetable {
	return o.Payload
}

func (o *GeneralStationTimetableAPIControllerGet3209OK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGeneralStationTimetableAPIControllerGet3209Status299() *GeneralStationTimetableAPIControllerGet3209Status299 {
	return &GeneralStationTimetableAPIControllerGet3209Status299{}
}
...
func (o *GeneralStationTimetableAPIControllerGet3209Status299) Error() string {
	return fmt.Sprintf("[GET /v3/Rail/TRA/GeneralStationTimetable][%d] generalStationTimetableApiControllerGet3209Status299  %+v", 299, o.Payload)
}
func (o *GeneralStationTimetableAPIControllerGet3209Status299) GetPayload() *models.PTXServiceDTOSharedSpecificationV3BaseDisplayHealth {
	return o.Payload
}

func (o *GeneralStationTimetableAPIControllerGet3209Status299) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGeneralStationTimetableAPIControllerGet3209NotModified() *GeneralStationTimetableAPIControllerGet3209NotModified {
	return &GeneralStationTimetableAPIControllerGet3209NotModified{}
}
...
func (o *GeneralStationTimetableAPIControllerGet3209NotModified) Error() string {
	return fmt.Sprintf("[GET /v3/Rail/TRA/GeneralStationTimetable][%d] generalStationTimetableApiControllerGet3209NotModified ", 304)
}

func (o *GeneralStationTimetableAPIControllerGet3209NotModified) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
