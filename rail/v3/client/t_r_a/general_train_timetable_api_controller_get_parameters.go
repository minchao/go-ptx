...
func (o *GeneralTrainTimetableAPIControllerGetParams) WithHealth(health *string) *GeneralTrainTimetableAPIControllerGetParams {
	o.SetHealth(health)
	return o
}

// SetHealth adds the health to the general train timetable Api controller get params
func (o *GeneralTrainTimetableAPIControllerGetParams) SetHealth(health *string) {
	o.Health = health
}
