...
func (o *StationFacilityAPIControllerGetParams) WithDollarTop(dollarTop *string) *StationFacilityAPIControllerGetParams {
	o.SetDollarTop(dollarTop)
	return o
}

// SetDollarTop adds the dollarTop to the station facility Api controller get params
func (o *StationFacilityAPIControllerGetParams) SetDollarTop(dollarTop *string) {
