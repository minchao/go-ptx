...
func (o *DailyStationTimeTableAPIControllerGetParams) WithHealth(health *string) *DailyStationTimeTableAPIControllerGetParams {
	o.SetHealth(health)
	return o
}

// SetHealth adds the health to the daily station time table Api controller get params
func (o *DailyStationTimeTableAPIControllerGetParams) SetHealth(health *string) {
	o.Health = health
}
