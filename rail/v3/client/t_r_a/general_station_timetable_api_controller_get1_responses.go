...
func (o *GeneralStationTimetableAPIControllerGet1Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 299:
		result := NewGeneralStationTimetableAPIControllerGet1Status299()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
...
func NewGeneralStationTimetableAPIControllerGet1Status299() *GeneralStationTimetableAPIControllerGet1Status299 {
	return &GeneralStationTimetableAPIControllerGet1Status299{}
}
...
func (o *GeneralStationTimetableAPIControllerGet1Status299) Error() string {
	return fmt.Sprintf("[GET /v3/Rail/TRA/GeneralStationTimetable/Station/{StationID}][%d] generalStationTimetableApiControllerGet1Status299  %+v", 299, o.Payload)
}
func (o *GeneralStationTimetableAPIControllerGet1Status299) GetPayload() *models.PTXServiceDTOSharedSpecificationV3BaseDisplayHealth {
	return o.Payload
}

func (o *GeneralStationTimetableAPIControllerGet1Status299) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
