...
type InterCityBusAPIEstimatedTimeOfArrivalUDP1Reader struct {
	formats strfmt.Registry
}

// ReadResponse reads a server response into the received o.
func (o *InterCityBusAPIEstimatedTimeOfArrivalUDP1Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	switch response.Code() {
	case 200:
		result := NewInterCityBusAPIEstimatedTimeOfArrivalUdp1OK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 299:
		result := NewInterCityBusAPIEstimatedTimeOfArrivalUdp1Status299()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
...
// NewInterCityBusAPIEstimatedTimeOfArrivalUdp1OK creates a InterCityBusAPIEstimatedTimeOfArrivalUdp1OK with default headers values
func NewInterCityBusAPIEstimatedTimeOfArrivalUdp1OK() *InterCityBusAPIEstimatedTimeOfArrivalUdp1OK {
...
func (o *InterCityBusAPIEstimatedTimeOfArrivalUdp1OK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
// NewInterCityBusAPIEstimatedTimeOfArrivalUdp1Status299 creates a InterCityBusAPIEstimatedTimeOfArrivalUdp1Status299 with default headers values
func NewInterCityBusAPIEstimatedTimeOfArrivalUdp1Status299() *InterCityBusAPIEstimatedTimeOfArrivalUdp1Status299 {
