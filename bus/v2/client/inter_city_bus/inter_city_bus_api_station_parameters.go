...
func (o *InterCityBusAPIStationParams) WithDollarTop(dollarTop *string) *InterCityBusAPIStationParams {
	o.SetDollarTop(dollarTop)
	return o
}

// SetDollarTop adds the dollarTop to the inter city bus Api station params
func (o *InterCityBusAPIStationParams) SetDollarTop(dollarTop *string) {
