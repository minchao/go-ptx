...
// NewInterCityBusAPIRealTimeNearStopByOperator2887Params creates a new InterCityBusAPIRealTimeNearStopByOperator2887Params object,
...
func NewInterCityBusAPIRealTimeNearStopByOperator2887Params() *InterCityBusAPIRealTimeNearStopByOperator2887Params {
	return &InterCityBusAPIRealTimeNearStopByOperator2887Params{
		timeout: cr.DefaultTimeout,
	}
}

// NewInterCityBusAPIRealTimeNearStopByOperator2887ParamsWithTimeout creates a new InterCityBusAPIRealTimeNearStopByOperator2887Params object
...
// NewInterCityBusAPIRealTimeNearStopByOperator2887ParamsWithContext creates a new InterCityBusAPIRealTimeNearStopByOperator2887Params object
...
// NewInterCityBusAPIRealTimeNearStopByOperator2887ParamsWithHTTPClient creates a new InterCityBusAPIRealTimeNearStopByOperator2887Params object
...
func (o *InterCityBusAPIRealTimeNearStopByOperator2887Params) WithDefaults() *InterCityBusAPIRealTimeNearStopByOperator2887Params {
	o.SetDefaults()
	return o
}
...
//
// All values with no default are reset to their zero value.
func (o *InterCityBusAPIRealTimeNearStopByOperator2887Params) SetDefaults() {
	var (
		dollarTopDefault = int64(30)
	)

	val := InterCityBusAPIRealTimeNearStopByOperator2887Params{
...
func (o *InterCityBusAPIRealTimeNearStopByOperator2887Params) WithTimeout(timeout time.Duration) *InterCityBusAPIRealTimeNearStopByOperator2887Params {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the inter city bus Api real time near stop by operator 2887 params
func (o *InterCityBusAPIRealTimeNearStopByOperator2887Params) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the inter city bus Api real time near stop by operator 2887 params
func (o *InterCityBusAPIRealTimeNearStopByOperator2887Params) WithContext(ctx context.Context) *InterCityBusAPIRealTimeNearStopByOperator2887Params {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the inter city bus Api real time near stop by operator 2887 params
func (o *InterCityBusAPIRealTimeNearStopByOperator2887Params) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the inter city bus Api real time near stop by operator 2887 params
func (o *InterCityBusAPIRealTimeNearStopByOperator2887Params) WithHTTPClient(client *http.Client) *InterCityBusAPIRealTimeNearStopByOperator2887Params {
	o.SetHTTPClient(client)
	return o
}

// SetHTTPClient adds the HTTPClient to the inter city bus Api real time near stop by operator 2887 params
func (o *InterCityBusAPIRealTimeNearStopByOperator2887Params) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}

// WithDollarFilter adds the dollarFilter to the inter city bus Api real time near stop by operator 2887 params
func (o *InterCityBusAPIRealTimeNearStopByOperator2887Params) WithDollarFilter(dollarFilter *string) *InterCityBusAPIRealTimeNearStopByOperator2887Params {
...
func (o *InterCityBusAPIRealTimeNearStopByOperator2887Params) WithDollarFormat(dollarFormat string) *InterCityBusAPIRealTimeNearStopByOperator2887Params {
...
func (o *InterCityBusAPIRealTimeNearStopByOperator2887Params) WithDollarOrderby(dollarOrderby *string) *InterCityBusAPIRealTimeNearStopByOperator2887Params {
...
func (o *InterCityBusAPIRealTimeNearStopByOperator2887Params) WithDollarSelect(dollarSelect *string) *InterCityBusAPIRealTimeNearStopByOperator2887Params {
...
func (o *InterCityBusAPIRealTimeNearStopByOperator2887Params) WithDollarSkip(dollarSkip *string) *InterCityBusAPIRealTimeNearStopByOperator2887Params {
...
func (o *InterCityBusAPIRealTimeNearStopByOperator2887Params) WithDollarTop(dollarTop *int64) *InterCityBusAPIRealTimeNearStopByOperator2887Params {
...
func (o *InterCityBusAPIRealTimeNearStopByOperator2887Params) WithOperatorNo(operatorNo string) *InterCityBusAPIRealTimeNearStopByOperator2887Params {
...
func (o *InterCityBusAPIRealTimeNearStopByOperator2887Params) WithHealth(health *string) *InterCityBusAPIRealTimeNearStopByOperator2887Params {
	o.SetHealth(health)
	return o
}

// SetHealth adds the health to the inter city bus Api real time near stop by operator 2887 params
func (o *InterCityBusAPIRealTimeNearStopByOperator2887Params) SetHealth(health *string) {
	o.Health = health
}

// WriteToRequest writes these params to a swagger request
func (o *InterCityBusAPIRealTimeNearStopByOperator2887Params) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
