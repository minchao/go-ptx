...
// NewCityBusAPIStationByOperator2861Params creates a new CityBusAPIStationByOperator2861Params object,
...
func NewCityBusAPIStationByOperator2861Params() *CityBusAPIStationByOperator2861Params {
	return &CityBusAPIStationByOperator2861Params{
		timeout: cr.DefaultTimeout,
	}
}

// NewCityBusAPIStationByOperator2861ParamsWithTimeout creates a new CityBusAPIStationByOperator2861Params object
...
// NewCityBusAPIStationByOperator2861ParamsWithContext creates a new CityBusAPIStationByOperator2861Params object
...
// NewCityBusAPIStationByOperator2861ParamsWithHTTPClient creates a new CityBusAPIStationByOperator2861Params object
...
func (o *CityBusAPIStationByOperator2861Params) WithDefaults() *CityBusAPIStationByOperator2861Params {
	o.SetDefaults()
	return o
}
...
func (o *CityBusAPIStationByOperator2861Params) SetDefaults() {
	...
	val := CityBusAPIStationByOperator2861Params{
...
func (o *CityBusAPIStationByOperator2861Params) WithTimeout(timeout time.Duration) *CityBusAPIStationByOperator2861Params {
...
func (o *CityBusAPIStationByOperator2861Params) WithContext(ctx context.Context) *CityBusAPIStationByOperator2861Params {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the city bus Api station by operator 2861 params
func (o *CityBusAPIStationByOperator2861Params) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the city bus Api station by operator 2861 params
func (o *CityBusAPIStationByOperator2861Params) WithHTTPClient(client *http.Client) *CityBusAPIStationByOperator2861Params {
...
func (o *CityBusAPIStationByOperator2861Params) WithDollarFilter(dollarFilter *string) *CityBusAPIStationByOperator2861Params {
...
func (o *CityBusAPIStationByOperator2861Params) WithDollarFormat(dollarFormat string) *CityBusAPIStationByOperator2861Params {
...
func (o *CityBusAPIStationByOperator2861Params) WithDollarOrderby(dollarOrderby *string) *CityBusAPIStationByOperator2861Params {
...
func (o *CityBusAPIStationByOperator2861Params) WithDollarSelect(dollarSelect *string) *CityBusAPIStationByOperator2861Params {
...
func (o *CityBusAPIStationByOperator2861Params) WithDollarSkip(dollarSkip *string) *CityBusAPIStationByOperator2861Params {
...
func (o *CityBusAPIStationByOperator2861Params) WithDollarTop(dollarTop *int64) *CityBusAPIStationByOperator2861Params {
...
func (o *CityBusAPIStationByOperator2861Params) WithCity(city string) *CityBusAPIStationByOperator2861Params {
	o.SetCity(city)
	return o
}

// SetCity adds the city to the city bus Api station by operator 2861 params
func (o *CityBusAPIStationByOperator2861Params) SetCity(city string) {
	o.City = city
}

// WithOperatorNo adds the operatorNo to the city bus Api station by operator 2861 params
func (o *CityBusAPIStationByOperator2861Params) WithOperatorNo(operatorNo string) *CityBusAPIStationByOperator2861Params {
...
func (o *CityBusAPIStationByOperator2861Params) WithHealth(health *string) *CityBusAPIStationByOperator2861Params {
	o.SetHealth(health)
	return o
}
...
func (o *CityBusAPIStationByOperator2861Params) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
