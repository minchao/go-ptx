...
// NewCityBusAPIStopOfRouteByOperator2862Params creates a new CityBusAPIStopOfRouteByOperator2862Params object,
...
func NewCityBusAPIStopOfRouteByOperator2862Params() *CityBusAPIStopOfRouteByOperator2862Params {
	return &CityBusAPIStopOfRouteByOperator2862Params{
		timeout: cr.DefaultTimeout,
	}
}

// NewCityBusAPIStopOfRouteByOperator2862ParamsWithTimeout creates a new CityBusAPIStopOfRouteByOperator2862Params object
...
// NewCityBusAPIStopOfRouteByOperator2862ParamsWithContext creates a new CityBusAPIStopOfRouteByOperator2862Params object
...
// NewCityBusAPIStopOfRouteByOperator2862ParamsWithHTTPClient creates a new CityBusAPIStopOfRouteByOperator2862Params object
...
func (o *CityBusAPIStopOfRouteByOperator2862Params) WithDefaults() *CityBusAPIStopOfRouteByOperator2862Params {
	o.SetDefaults()
	return o
}
...
//
// All values with no default are reset to their zero value.
func (o *CityBusAPIStopOfRouteByOperator2862Params) SetDefaults() {
	var (
		dollarTopDefault = int64(30)
	)

	val := CityBusAPIStopOfRouteByOperator2862Params{
...
func (o *CityBusAPIStopOfRouteByOperator2862Params) WithTimeout(timeout time.Duration) *CityBusAPIStopOfRouteByOperator2862Params {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the city bus Api stop of route by operator 2862 params
func (o *CityBusAPIStopOfRouteByOperator2862Params) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the city bus Api stop of route by operator 2862 params
func (o *CityBusAPIStopOfRouteByOperator2862Params) WithContext(ctx context.Context) *CityBusAPIStopOfRouteByOperator2862Params {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the city bus Api stop of route by operator 2862 params
func (o *CityBusAPIStopOfRouteByOperator2862Params) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the city bus Api stop of route by operator 2862 params
func (o *CityBusAPIStopOfRouteByOperator2862Params) WithHTTPClient(client *http.Client) *CityBusAPIStopOfRouteByOperator2862Params {
...
func (o *CityBusAPIStopOfRouteByOperator2862Params) WithDollarFilter(dollarFilter *string) *CityBusAPIStopOfRouteByOperator2862Params {
...
func (o *CityBusAPIStopOfRouteByOperator2862Params) WithDollarFormat(dollarFormat string) *CityBusAPIStopOfRouteByOperator2862Params {
...
func (o *CityBusAPIStopOfRouteByOperator2862Params) WithDollarOrderby(dollarOrderby *string) *CityBusAPIStopOfRouteByOperator2862Params {
...
func (o *CityBusAPIStopOfRouteByOperator2862Params) WithDollarSelect(dollarSelect *string) *CityBusAPIStopOfRouteByOperator2862Params {
...
func (o *CityBusAPIStopOfRouteByOperator2862Params) WithDollarSkip(dollarSkip *string) *CityBusAPIStopOfRouteByOperator2862Params {
...
func (o *CityBusAPIStopOfRouteByOperator2862Params) WithDollarTop(dollarTop *int64) *CityBusAPIStopOfRouteByOperator2862Params {
...
func (o *CityBusAPIStopOfRouteByOperator2862Params) WithCity(city string) *CityBusAPIStopOfRouteByOperator2862Params {
	o.SetCity(city)
	return o
}

// SetCity adds the city to the city bus Api stop of route by operator 2862 params
func (o *CityBusAPIStopOfRouteByOperator2862Params) SetCity(city string) {
	o.City = city
}

// WithOperatorNo adds the operatorNo to the city bus Api stop of route by operator 2862 params
func (o *CityBusAPIStopOfRouteByOperator2862Params) WithOperatorNo(operatorNo string) *CityBusAPIStopOfRouteByOperator2862Params {
...
func (o *CityBusAPIStopOfRouteByOperator2862Params) WithHealth(health *string) *CityBusAPIStopOfRouteByOperator2862Params {
	o.SetHealth(health)
	return o
}
...
func (o *CityBusAPIStopOfRouteByOperator2862Params) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
