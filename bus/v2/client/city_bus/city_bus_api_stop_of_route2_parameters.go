...
// WithRouteName adds the routeName to the city bus Api stop of route 2 params
func (o *CityBusAPIStopOfRoute2Params) WithRouteName(routeName string) *CityBusAPIStopOfRoute2Params {
	o.SetRouteName(routeName)
	return o
}

// SetRouteName adds the routeName to the city bus Api stop of route 2 params
func (o *CityBusAPIStopOfRoute2Params) SetRouteName(routeName string) {
