...
func (o *CityBusAPIRealTimeByFrequency2OK) Error() string {
	return fmt.Sprintf("[GET /v2/Bus/RealTimeByFrequency/City/{City}][%d] cityBusApiRealTimeByFrequency2OK  %+v", 200, o.Payload)
}
func (o *CityBusAPIRealTimeByFrequency2OK) GetPayload() []*models.PTXServiceDTOBusSpecificationV2BusA1Data {
	return o.Payload
}
...
func (o *CityBusAPIRealTimeByFrequency2Status299) Error() string {
	return fmt.Sprintf("[GET /v2/Bus/RealTimeByFrequency/City/{City}][%d] cityBusApiRealTimeByFrequency2Status299  %+v", 299, o.Payload)
}
...
func (o *CityBusAPIRealTimeByFrequency2NotModified) Error() string {
	return fmt.Sprintf("[GET /v2/Bus/RealTimeByFrequency/City/{City}][%d] cityBusApiRealTimeByFrequency2NotModified ", 304)
}
