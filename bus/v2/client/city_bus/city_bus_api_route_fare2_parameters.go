...
// WithRouteName adds the routeName to the city bus Api route fare 2 params
func (o *CityBusAPIRouteFare2Params) WithRouteName(routeName string) *CityBusAPIRouteFare2Params {
	o.SetRouteName(routeName)
	return o
}

// SetRouteName adds the routeName to the city bus Api route fare 2 params
func (o *CityBusAPIRouteFare2Params) SetRouteName(routeName string) {
