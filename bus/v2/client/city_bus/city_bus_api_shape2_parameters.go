...
// WithRouteName adds the routeName to the city bus Api shape 2 params
func (o *CityBusAPIShape2Params) WithRouteName(routeName string) *CityBusAPIShape2Params {
	o.SetRouteName(routeName)
	return o
}

// SetRouteName adds the routeName to the city bus Api shape 2 params
func (o *CityBusAPIShape2Params) SetRouteName(routeName string) {
