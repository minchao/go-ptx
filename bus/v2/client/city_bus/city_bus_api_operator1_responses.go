...
func (o *CityBusAPIOperator1OK) Error() string {
	return fmt.Sprintf("[GET /v2/Bus/Operator/City/{City}][%d] cityBusApiOperator1OK  %+v", 200, o.Payload)
}
func (o *CityBusAPIOperator1OK) GetPayload() []*models.PTXServiceDTOSharedSpecificationV2BaseOperator {
	return o.Payload
}
...
func (o *CityBusAPIOperator1Status299) Error() string {
	return fmt.Sprintf("[GET /v2/Bus/Operator/City/{City}][%d] cityBusApiOperator1Status299  %+v", 299, o.Payload)
}
...
func (o *CityBusAPIOperator1NotModified) Error() string {
	return fmt.Sprintf("[GET /v2/Bus/Operator/City/{City}][%d] cityBusApiOperator1NotModified ", 304)
}
