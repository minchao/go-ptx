...
func (o *CityBusAPIEstimatedTimeOfArrivalUDP1Params) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the city bus Api estimated time of arrival UDP 1 params
func (o *CityBusAPIEstimatedTimeOfArrivalUDP1Params) WithContext(ctx context.Context) *CityBusAPIEstimatedTimeOfArrivalUDP1Params {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the city bus Api estimated time of arrival UDP 1 params
func (o *CityBusAPIEstimatedTimeOfArrivalUDP1Params) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the city bus Api estimated time of arrival UDP 1 params
func (o *CityBusAPIEstimatedTimeOfArrivalUDP1Params) WithHTTPClient(client *http.Client) *CityBusAPIEstimatedTimeOfArrivalUDP1Params {
...
func (o *CityBusAPIEstimatedTimeOfArrivalUDP1Params) WithDollarFilter(dollarFilter *string) *CityBusAPIEstimatedTimeOfArrivalUDP1Params {
...
func (o *CityBusAPIEstimatedTimeOfArrivalUDP1Params) WithDollarFormat(dollarFormat string) *CityBusAPIEstimatedTimeOfArrivalUDP1Params {
...
func (o *CityBusAPIEstimatedTimeOfArrivalUDP1Params) WithDollarOrderby(dollarOrderby *string) *CityBusAPIEstimatedTimeOfArrivalUDP1Params {
...
func (o *CityBusAPIEstimatedTimeOfArrivalUDP1Params) WithDollarSelect(dollarSelect *string) *CityBusAPIEstimatedTimeOfArrivalUDP1Params {
...
func (o *CityBusAPIEstimatedTimeOfArrivalUDP1Params) WithDollarSkip(dollarSkip *string) *CityBusAPIEstimatedTimeOfArrivalUDP1Params {
...
func (o *CityBusAPIEstimatedTimeOfArrivalUDP1Params) WithDollarTop(dollarTop *int64) *CityBusAPIEstimatedTimeOfArrivalUDP1Params {
...
func (o *CityBusAPIEstimatedTimeOfArrivalUDP1Params) WithCity(city string) *CityBusAPIEstimatedTimeOfArrivalUDP1Params {
	o.SetCity(city)
	return o
}

// SetCity adds the city to the city bus Api estimated time of arrival UDP 1 params
func (o *CityBusAPIEstimatedTimeOfArrivalUDP1Params) SetCity(city string) {
	o.City = city
}

// WithRouteName adds the routeName to the city bus Api estimated time of arrival UDP 1 params
func (o *CityBusAPIEstimatedTimeOfArrivalUDP1Params) WithRouteName(routeName string) *CityBusAPIEstimatedTimeOfArrivalUDP1Params {
...
func (o *CityBusAPIEstimatedTimeOfArrivalUDP1Params) WithHealth(health *string) *CityBusAPIEstimatedTimeOfArrivalUDP1Params {
	o.SetHealth(health)
	return o
}
...
func (o *CityBusAPIEstimatedTimeOfArrivalUDP1Params) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
