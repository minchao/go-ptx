...
func (o *CityBusAPIStopOfRoute1Params) WithDollarTop(dollarTop *string) *CityBusAPIStopOfRoute1Params {
	o.SetDollarTop(dollarTop)
	return o
}

// SetDollarTop adds the dollarTop to the city bus Api stop of route 1 params
func (o *CityBusAPIStopOfRoute1Params) SetDollarTop(dollarTop *string) {
