...
func (o *CityBusAPINews1OK) Error() string {
	return fmt.Sprintf("[GET /v2/Bus/News/City/{City}][%d] cityBusApiNews1OK  %+v", 200, o.Payload)
}
func (o *CityBusAPINews1OK) GetPayload() []*models.PTXServiceDTOBusSpecificationV2BusNews {
	return o.Payload
}
...
func (o *CityBusAPINews1Status299) Error() string {
	return fmt.Sprintf("[GET /v2/Bus/News/City/{City}][%d] cityBusApiNews1Status299  %+v", 299, o.Payload)
}
...
func (o *CityBusAPINews1NotModified) Error() string {
	return fmt.Sprintf("[GET /v2/Bus/News/City/{City}][%d] cityBusApiNews1NotModified ", 304)
}
