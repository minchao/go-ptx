...
func (o *CityBusAPIFirstLastTripInfo2OK) Error() string {
	return fmt.Sprintf("[GET /v2/Bus/FirstLastTripInfo/City/{City}/{RouteName}][%d] cityBusApiFirstLastTripInfo2OK  %+v", 200, o.Payload)
}
func (o *CityBusAPIFirstLastTripInfo2OK) GetPayload() []*models.PTXServiceDTOBusSpecificationV2BusFirstLastTripInfo {
	return o.Payload
}
...
func (o *CityBusAPIFirstLastTripInfo2Status299) Error() string {
	return fmt.Sprintf("[GET /v2/Bus/FirstLastTripInfo/City/{City}/{RouteName}][%d] cityBusApiFirstLastTripInfo2Status299  %+v", 299, o.Payload)
}
...
func (o *CityBusAPIFirstLastTripInfo2NotModified) Error() string {
	return fmt.Sprintf("[GET /v2/Bus/FirstLastTripInfo/City/{City}/{RouteName}][%d] cityBusApiFirstLastTripInfo2NotModified ", 304)
}
