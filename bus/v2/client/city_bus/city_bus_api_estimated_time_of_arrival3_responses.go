...
func (o *CityBusAPIEstimatedTimeOfArrival3OK) Error() string {
	return fmt.Sprintf("[GET /v2/Bus/EstimatedTimeOfArrival/City/{City}/{RouteName}][%d] cityBusApiEstimatedTimeOfArrival3OK  %+v", 200, o.Payload)
}
func (o *CityBusAPIEstimatedTimeOfArrival3OK) GetPayload() []*models.PTXServiceDTOBusSpecificationV2BusN1EstimateTime {
	return o.Payload
}
...
func (o *CityBusAPIEstimatedTimeOfArrival3Status299) Error() string {
	return fmt.Sprintf("[GET /v2/Bus/EstimatedTimeOfArrival/City/{City}/{RouteName}][%d] cityBusApiEstimatedTimeOfArrival3Status299  %+v", 299, o.Payload)
}
...
func (o *CityBusAPIEstimatedTimeOfArrival3NotModified) Error() string {
	return fmt.Sprintf("[GET /v2/Bus/EstimatedTimeOfArrival/City/{City}/{RouteName}][%d] cityBusApiEstimatedTimeOfArrival3NotModified ", 304)
}
