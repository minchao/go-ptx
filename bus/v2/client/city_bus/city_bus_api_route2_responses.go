...
func (o *CityBusAPIRoute2OK) Error() string {
	return fmt.Sprintf("[GET /v2/Bus/Route/City/{City}/{RouteName}][%d] cityBusApiRoute2OK  %+v", 200, o.Payload)
}
func (o *CityBusAPIRoute2OK) GetPayload() []*models.PTXServiceDTOBusSpecificationV2BusRoute {
	return o.Payload
}
...
func (o *CityBusAPIRoute2Status299) Error() string {
	return fmt.Sprintf("[GET /v2/Bus/Route/City/{City}/{RouteName}][%d] cityBusApiRoute2Status299  %+v", 299, o.Payload)
}
...
func (o *CityBusAPIRoute2NotModified) Error() string {
	return fmt.Sprintf("[GET /v2/Bus/Route/City/{City}/{RouteName}][%d] cityBusApiRoute2NotModified ", 304)
}
