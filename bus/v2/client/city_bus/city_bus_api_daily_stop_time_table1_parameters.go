...
// NewCityBusAPIDailyStopTimeTable1Params creates a new CityBusAPIDailyStopTimeTable1Params object,
...
func NewCityBusAPIDailyStopTimeTable1Params() *CityBusAPIDailyStopTimeTable1Params {
	return &CityBusAPIDailyStopTimeTable1Params{
		timeout: cr.DefaultTimeout,
	}
}

// NewCityBusAPIDailyStopTimeTable1ParamsWithTimeout creates a new CityBusAPIDailyStopTimeTable1Params object
...
// NewCityBusAPIDailyStopTimeTable1ParamsWithContext creates a new CityBusAPIDailyStopTimeTable1Params object
...
// NewCityBusAPIDailyStopTimeTable1ParamsWithHTTPClient creates a new CityBusAPIDailyStopTimeTable1Params object
...
func (o *CityBusAPIDailyStopTimeTable1Params) WithDefaults() *CityBusAPIDailyStopTimeTable1Params {
	o.SetDefaults()
	return o
}
...
func (o *CityBusAPIDailyStopTimeTable1Params) SetDefaults() {
	...
	val := CityBusAPIDailyStopTimeTable1Params{
...
func (o *CityBusAPIDailyStopTimeTable1Params) WithTimeout(timeout time.Duration) *CityBusAPIDailyStopTimeTable1Params {
...
func (o *CityBusAPIDailyStopTimeTable1Params) WithContext(ctx context.Context) *CityBusAPIDailyStopTimeTable1Params {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the city bus Api daily stop time table 1 params
func (o *CityBusAPIDailyStopTimeTable1Params) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the city bus Api daily stop time table 1 params
func (o *CityBusAPIDailyStopTimeTable1Params) WithHTTPClient(client *http.Client) *CityBusAPIDailyStopTimeTable1Params {
...
func (o *CityBusAPIDailyStopTimeTable1Params) WithDollarFilter(dollarFilter *string) *CityBusAPIDailyStopTimeTable1Params {
...
func (o *CityBusAPIDailyStopTimeTable1Params) WithDollarFormat(dollarFormat string) *CityBusAPIDailyStopTimeTable1Params {
...
func (o *CityBusAPIDailyStopTimeTable1Params) WithDollarOrderby(dollarOrderby *string) *CityBusAPIDailyStopTimeTable1Params {
...
func (o *CityBusAPIDailyStopTimeTable1Params) WithDollarSelect(dollarSelect *string) *CityBusAPIDailyStopTimeTable1Params {
...
func (o *CityBusAPIDailyStopTimeTable1Params) WithDollarSkip(dollarSkip *string) *CityBusAPIDailyStopTimeTable1Params {
...
func (o *CityBusAPIDailyStopTimeTable1Params) WithDollarTop(dollarTop *int64) *CityBusAPIDailyStopTimeTable1Params {
...
func (o *CityBusAPIDailyStopTimeTable1Params) WithCity(city string) *CityBusAPIDailyStopTimeTable1Params {
	o.SetCity(city)
	return o
}

// SetCity adds the city to the city bus Api daily stop time table 1 params
func (o *CityBusAPIDailyStopTimeTable1Params) SetCity(city string) {
	o.City = city
}

// WithRouteName adds the routeName to the city bus Api daily stop time table 1 params
func (o *CityBusAPIDailyStopTimeTable1Params) WithRouteName(routeName string) *CityBusAPIDailyStopTimeTable1Params {
...
func (o *CityBusAPIDailyStopTimeTable1Params) WithHealth(health *string) *CityBusAPIDailyStopTimeTable1Params {
	o.SetHealth(health)
	return o
}
...
func (o *CityBusAPIDailyStopTimeTable1Params) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
