...
// WithRouteName adds the routeName to the city bus Api display stop of route 2 params
func (o *CityBusAPIDisplayStopOfRoute2Params) WithRouteName(routeName string) *CityBusAPIDisplayStopOfRoute2Params {
	o.SetRouteName(routeName)
	return o
}

// SetRouteName adds the routeName to the city bus Api display stop of route 2 params
func (o *CityBusAPIDisplayStopOfRoute2Params) SetRouteName(routeName string) {
