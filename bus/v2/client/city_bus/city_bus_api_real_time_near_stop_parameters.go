...
func (o *CityBusAPIRealTimeNearStopParams) WithDollarTop(dollarTop *string) *CityBusAPIRealTimeNearStopParams {
	o.SetDollarTop(dollarTop)
	return o
}

// SetDollarTop adds the dollarTop to the city bus Api real time near stop params
func (o *CityBusAPIRealTimeNearStopParams) SetDollarTop(dollarTop *string) {
