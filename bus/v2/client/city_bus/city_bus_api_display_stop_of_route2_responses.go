...
func (o *CityBusAPIDisplayStopOfRoute2OK) Error() string {
	return fmt.Sprintf("[GET /v2/Bus/DisplayStopOfRoute/City/{City}/{RouteName}][%d] cityBusApiDisplayStopOfRoute2OK  %+v", 200, o.Payload)
}
func (o *CityBusAPIDisplayStopOfRoute2OK) GetPayload() []*models.PTXServiceDTOBusSpecificationV2BusDisplayStopOfRoute {
	return o.Payload
}
...
func (o *CityBusAPIDisplayStopOfRoute2Status299) Error() string {
	return fmt.Sprintf("[GET /v2/Bus/DisplayStopOfRoute/City/{City}/{RouteName}][%d] cityBusApiDisplayStopOfRoute2Status299  %+v", 299, o.Payload)
}
...
func (o *CityBusAPIDisplayStopOfRoute2NotModified) Error() string {
	return fmt.Sprintf("[GET /v2/Bus/DisplayStopOfRoute/City/{City}/{RouteName}][%d] cityBusApiDisplayStopOfRoute2NotModified ", 304)
}
