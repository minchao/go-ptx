...
func (o *CityBusAPIRouteFare2OK) Error() string {
	return fmt.Sprintf("[GET /v2/Bus/RouteFare/City/{City}/{RouteName}][%d] cityBusApiRouteFare2OK  %+v", 200, o.Payload)
}
func (o *CityBusAPIRouteFare2OK) GetPayload() []*models.PTXServiceDTOBusSpecificationV2BusRouteFare {
	return o.Payload
}
...
func (o *CityBusAPIRouteFare2Status299) Error() string {
	return fmt.Sprintf("[GET /v2/Bus/RouteFare/City/{City}/{RouteName}][%d] cityBusApiRouteFare2Status299  %+v", 299, o.Payload)
}
...
func (o *CityBusAPIRouteFare2NotModified) Error() string {
	return fmt.Sprintf("[GET /v2/Bus/RouteFare/City/{City}/{RouteName}][%d] cityBusApiRouteFare2NotModified ", 304)
}
