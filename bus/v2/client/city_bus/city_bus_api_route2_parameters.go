...
// WithRouteName adds the routeName to the city bus Api route 2 params
func (o *CityBusAPIRoute2Params) WithRouteName(routeName string) *CityBusAPIRoute2Params {
	o.SetRouteName(routeName)
	return o
}

// SetRouteName adds the routeName to the city bus Api route 2 params
func (o *CityBusAPIRoute2Params) SetRouteName(routeName string) {
