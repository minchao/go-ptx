...
func (o *CityBusAPIShape2OK) Error() string {
	return fmt.Sprintf("[GET /v2/Bus/Shape/City/{City}/{RouteName}][%d] cityBusApiShape2OK  %+v", 200, o.Payload)
}
func (o *CityBusAPIShape2OK) GetPayload() []*models.PTXServiceDTOBusSpecificationV2BusShape {
	return o.Payload
}
...
func (o *CityBusAPIShape2Status299) Error() string {
	return fmt.Sprintf("[GET /v2/Bus/Shape/City/{City}/{RouteName}][%d] cityBusApiShape2Status299  %+v", 299, o.Payload)
}
...
func (o *CityBusAPIShape2NotModified) Error() string {
	return fmt.Sprintf("[GET /v2/Bus/Shape/City/{City}/{RouteName}][%d] cityBusApiShape2NotModified ", 304)
}
