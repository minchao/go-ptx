...
func (o *CityBusAPIRealTimeNearStopUDP1Params) WithContext(ctx context.Context) *CityBusAPIRealTimeNearStopUDP1Params {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the city bus Api real time near stop UDP 1 params
func (o *CityBusAPIRealTimeNearStopUDP1Params) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the city bus Api real time near stop UDP 1 params
func (o *CityBusAPIRealTimeNearStopUDP1Params) WithHTTPClient(client *http.Client) *CityBusAPIRealTimeNearStopUDP1Params {
...
func (o *CityBusAPIRealTimeNearStopUDP1Params) WithDollarFilter(dollarFilter *string) *CityBusAPIRealTimeNearStopUDP1Params {
...
func (o *CityBusAPIRealTimeNearStopUDP1Params) WithDollarFormat(dollarFormat string) *CityBusAPIRealTimeNearStopUDP1Params {
...
func (o *CityBusAPIRealTimeNearStopUDP1Params) WithDollarOrderby(dollarOrderby *string) *CityBusAPIRealTimeNearStopUDP1Params {
...
func (o *CityBusAPIRealTimeNearStopUDP1Params) WithDollarSelect(dollarSelect *string) *CityBusAPIRealTimeNearStopUDP1Params {
...
func (o *CityBusAPIRealTimeNearStopUDP1Params) WithDollarSkip(dollarSkip *string) *CityBusAPIRealTimeNearStopUDP1Params {
...
func (o *CityBusAPIRealTimeNearStopUDP1Params) WithDollarTop(dollarTop *int64) *CityBusAPIRealTimeNearStopUDP1Params {
...
func (o *CityBusAPIRealTimeNearStopUDP1Params) WithCity(city string) *CityBusAPIRealTimeNearStopUDP1Params {
	o.SetCity(city)
	return o
}

// SetCity adds the city to the city bus Api real time near stop UDP 1 params
func (o *CityBusAPIRealTimeNearStopUDP1Params) SetCity(city string) {
	o.City = city
}

// WithRouteName adds the routeName to the city bus Api real time near stop UDP 1 params
func (o *CityBusAPIRealTimeNearStopUDP1Params) WithRouteName(routeName string) *CityBusAPIRealTimeNearStopUDP1Params {
...
func (o *CityBusAPIRealTimeNearStopUDP1Params) WithHealth(health *string) *CityBusAPIRealTimeNearStopUDP1Params {
	o.SetHealth(health)
	return o
}
...
func (o *CityBusAPIRealTimeNearStopUDP1Params) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
