...
func (o *CityBusAPIRealTimeNearStop3OK) Error() string {
	return fmt.Sprintf("[GET /v2/Bus/RealTimeNearStop/City/{City}/{RouteName}][%d] cityBusApiRealTimeNearStop3OK  %+v", 200, o.Payload)
}
func (o *CityBusAPIRealTimeNearStop3OK) GetPayload() []*models.PTXServiceDTOBusSpecificationV2BusA2Data {
	return o.Payload
}
...
func (o *CityBusAPIRealTimeNearStop3Status299) Error() string {
	return fmt.Sprintf("[GET /v2/Bus/RealTimeNearStop/City/{City}/{RouteName}][%d] cityBusApiRealTimeNearStop3Status299  %+v", 299, o.Payload)
}
...
func (o *CityBusAPIRealTimeNearStop3NotModified) Error() string {
	return fmt.Sprintf("[GET /v2/Bus/RealTimeNearStop/City/{City}/{RouteName}][%d] cityBusApiRealTimeNearStop3NotModified ", 304)
}
