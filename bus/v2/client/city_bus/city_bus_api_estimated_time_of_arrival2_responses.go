...
func (o *CityBusAPIEstimatedTimeOfArrival2OK) Error() string {
	return fmt.Sprintf("[GET /v2/Bus/EstimatedTimeOfArrival/City/{City}][%d] cityBusApiEstimatedTimeOfArrival2OK  %+v", 200, o.Payload)
}
func (o *CityBusAPIEstimatedTimeOfArrival2OK) GetPayload() []*models.PTXServiceDTOBusSpecificationV2BusN1EstimateTime {
	return o.Payload
}
...
func (o *CityBusAPIEstimatedTimeOfArrival2Status299) Error() string {
	return fmt.Sprintf("[GET /v2/Bus/EstimatedTimeOfArrival/City/{City}][%d] cityBusApiEstimatedTimeOfArrival2Status299  %+v", 299, o.Payload)
}
...
func (o *CityBusAPIEstimatedTimeOfArrival2NotModified) Error() string {
	return fmt.Sprintf("[GET /v2/Bus/EstimatedTimeOfArrival/City/{City}][%d] cityBusApiEstimatedTimeOfArrival2NotModified ", 304)
}
