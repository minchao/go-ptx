...
func (o *CityBusAPIStopOfRoute2OK) Error() string {
	return fmt.Sprintf("[GET /v2/Bus/StopOfRoute/City/{City}/{RouteName}][%d] cityBusApiStopOfRoute2OK  %+v", 200, o.Payload)
}
func (o *CityBusAPIStopOfRoute2OK) GetPayload() []*models.PTXServiceDTOBusSpecificationV2BusStopOfRoute {
	return o.Payload
}
...
func (o *CityBusAPIStopOfRoute2Status299) Error() string {
	return fmt.Sprintf("[GET /v2/Bus/StopOfRoute/City/{City}/{RouteName}][%d] cityBusApiStopOfRoute2Status299  %+v", 299, o.Payload)
}
...
func (o *CityBusAPIStopOfRoute2NotModified) Error() string {
	return fmt.Sprintf("[GET /v2/Bus/StopOfRoute/City/{City}/{RouteName}][%d] cityBusApiStopOfRoute2NotModified ", 304)
}
