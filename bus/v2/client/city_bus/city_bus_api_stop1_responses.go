...
func (o *CityBusAPIStop1OK) Error() string {
	return fmt.Sprintf("[GET /v2/Bus/Stop/City/{City}][%d] cityBusApiStop1OK  %+v", 200, o.Payload)
}
func (o *CityBusAPIStop1OK) GetPayload() []*models.PTXServiceDTOBusSpecificationV2BusStop {
	return o.Payload
}
...
func (o *CityBusAPIStop1Status299) Error() string {
	return fmt.Sprintf("[GET /v2/Bus/Stop/City/{City}][%d] cityBusApiStop1Status299  %+v", 299, o.Payload)
}
...
func (o *CityBusAPIStop1NotModified) Error() string {
	return fmt.Sprintf("[GET /v2/Bus/Stop/City/{City}][%d] cityBusApiStop1NotModified ", 304)
}
