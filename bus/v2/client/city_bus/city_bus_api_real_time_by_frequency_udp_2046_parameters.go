...
// NewCityBusAPIRealTimeByFrequencyUDP2046Params creates a new CityBusAPIRealTimeByFrequencyUDP2046Params object,
...
func NewCityBusAPIRealTimeByFrequencyUDP2046Params() *CityBusAPIRealTimeByFrequencyUDP2046Params {
	return &CityBusAPIRealTimeByFrequencyUDP2046Params{
		timeout: cr.DefaultTimeout,
	}
}

// NewCityBusAPIRealTimeByFrequencyUDP2046ParamsWithTimeout creates a new CityBusAPIRealTimeByFrequencyUDP2046Params object
...
// NewCityBusAPIRealTimeByFrequencyUDP2046ParamsWithContext creates a new CityBusAPIRealTimeByFrequencyUDP2046Params object
...
// NewCityBusAPIRealTimeByFrequencyUDP2046ParamsWithHTTPClient creates a new CityBusAPIRealTimeByFrequencyUDP2046Params object
...
func (o *CityBusAPIRealTimeByFrequencyUDP2046Params) WithDefaults() *CityBusAPIRealTimeByFrequencyUDP2046Params {
	o.SetDefaults()
	return o
}
...
//
// All values with no default are reset to their zero value.
func (o *CityBusAPIRealTimeByFrequencyUDP2046Params) SetDefaults() {
	var (
		dollarTopDefault = int64(30)
	)

	val := CityBusAPIRealTimeByFrequencyUDP2046Params{
...
func (o *CityBusAPIRealTimeByFrequencyUDP2046Params) WithTimeout(timeout time.Duration) *CityBusAPIRealTimeByFrequencyUDP2046Params {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the city bus Api real time by frequency UDP 2046 params
func (o *CityBusAPIRealTimeByFrequencyUDP2046Params) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the city bus Api real time by frequency UDP 2046 params
func (o *CityBusAPIRealTimeByFrequencyUDP2046Params) WithContext(ctx context.Context) *CityBusAPIRealTimeByFrequencyUDP2046Params {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the city bus Api real time by frequency UDP 2046 params
func (o *CityBusAPIRealTimeByFrequencyUDP2046Params) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the city bus Api real time by frequency UDP 2046 params
func (o *CityBusAPIRealTimeByFrequencyUDP2046Params) WithHTTPClient(client *http.Client) *CityBusAPIRealTimeByFrequencyUDP2046Params {
...
func (o *CityBusAPIRealTimeByFrequencyUDP2046Params) WithDollarFilter(dollarFilter *string) *CityBusAPIRealTimeByFrequencyUDP2046Params {
...
func (o *CityBusAPIRealTimeByFrequencyUDP2046Params) WithDollarFormat(dollarFormat string) *CityBusAPIRealTimeByFrequencyUDP2046Params {
...
func (o *CityBusAPIRealTimeByFrequencyUDP2046Params) WithDollarOrderby(dollarOrderby *string) *CityBusAPIRealTimeByFrequencyUDP2046Params {
...
func (o *CityBusAPIRealTimeByFrequencyUDP2046Params) WithDollarSelect(dollarSelect *string) *CityBusAPIRealTimeByFrequencyUDP2046Params {
...
func (o *CityBusAPIRealTimeByFrequencyUDP2046Params) WithDollarSkip(dollarSkip *string) *CityBusAPIRealTimeByFrequencyUDP2046Params {
...
func (o *CityBusAPIRealTimeByFrequencyUDP2046Params) WithDollarTop(dollarTop *int64) *CityBusAPIRealTimeByFrequencyUDP2046Params {
...
func (o *CityBusAPIRealTimeByFrequencyUDP2046Params) WithCity(city string) *CityBusAPIRealTimeByFrequencyUDP2046Params {
	o.SetCity(city)
	return o
}

// SetCity adds the city to the city bus Api real time by frequency UDP 2046 params
func (o *CityBusAPIRealTimeByFrequencyUDP2046Params) SetCity(city string) {
	o.City = city
}

// WithHealth adds the health to the city bus Api real time by frequency UDP 2046 params
func (o *CityBusAPIRealTimeByFrequencyUDP2046Params) WithHealth(health *string) *CityBusAPIRealTimeByFrequencyUDP2046Params {
	o.SetHealth(health)
	return o
}
...
func (o *CityBusAPIRealTimeByFrequencyUDP2046Params) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
