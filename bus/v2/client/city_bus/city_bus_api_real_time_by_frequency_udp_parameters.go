...
func (o *CityBusAPIRealTimeByFrequencyUDPParams) WithContext(ctx context.Context) *CityBusAPIRealTimeByFrequencyUDPParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the city bus Api real time by frequency UDP params
func (o *CityBusAPIRealTimeByFrequencyUDPParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the city bus Api real time by frequency UDP params
func (o *CityBusAPIRealTimeByFrequencyUDPParams) WithHTTPClient(client *http.Client) *CityBusAPIRealTimeByFrequencyUDPParams {
...
func (o *CityBusAPIRealTimeByFrequencyUDPParams) WithDollarFilter(dollarFilter *string) *CityBusAPIRealTimeByFrequencyUDPParams {
...
func (o *CityBusAPIRealTimeByFrequencyUDPParams) WithDollarFormat(dollarFormat string) *CityBusAPIRealTimeByFrequencyUDPParams {
...
func (o *CityBusAPIRealTimeByFrequencyUDPParams) WithDollarOrderby(dollarOrderby *string) *CityBusAPIRealTimeByFrequencyUDPParams {
...
func (o *CityBusAPIRealTimeByFrequencyUDPParams) WithDollarSelect(dollarSelect *string) *CityBusAPIRealTimeByFrequencyUDPParams {
...
func (o *CityBusAPIRealTimeByFrequencyUDPParams) WithDollarSkip(dollarSkip *string) *CityBusAPIRealTimeByFrequencyUDPParams {
...
func (o *CityBusAPIRealTimeByFrequencyUDPParams) WithDollarTop(dollarTop *int64) *CityBusAPIRealTimeByFrequencyUDPParams {
...
func (o *CityBusAPIRealTimeByFrequencyUDPParams) WithCity(city string) *CityBusAPIRealTimeByFrequencyUDPParams {
	o.SetCity(city)
	return o
}

// SetCity adds the city to the city bus Api real time by frequency UDP params
func (o *CityBusAPIRealTimeByFrequencyUDPParams) SetCity(city string) {
	o.City = city
}

// WithHealth adds the health to the city bus Api real time by frequency UDP params
func (o *CityBusAPIRealTimeByFrequencyUDPParams) WithHealth(health *string) *CityBusAPIRealTimeByFrequencyUDPParams {
	o.SetHealth(health)
	return o
}
...
func (o *CityBusAPIRealTimeByFrequencyUDPParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
