...
// NewCityBusAPIEstimatedTimeOfArrival20321Params creates a new CityBusAPIEstimatedTimeOfArrival20321Params object,
...
func NewCityBusAPIEstimatedTimeOfArrival20321Params() *CityBusAPIEstimatedTimeOfArrival20321Params {
	return &CityBusAPIEstimatedTimeOfArrival20321Params{
		timeout: cr.DefaultTimeout,
	}
}

// NewCityBusAPIEstimatedTimeOfArrival20321ParamsWithTimeout creates a new CityBusAPIEstimatedTimeOfArrival20321Params object
...
// NewCityBusAPIEstimatedTimeOfArrival20321ParamsWithContext creates a new CityBusAPIEstimatedTimeOfArrival20321Params object
...
// NewCityBusAPIEstimatedTimeOfArrival20321ParamsWithHTTPClient creates a new CityBusAPIEstimatedTimeOfArrival20321Params object
...
func (o *CityBusAPIEstimatedTimeOfArrival20321Params) WithDefaults() *CityBusAPIEstimatedTimeOfArrival20321Params {
	o.SetDefaults()
	return o
}
...
//
// All values with no default are reset to their zero value.
func (o *CityBusAPIEstimatedTimeOfArrival20321Params) SetDefaults() {
	var (
		dollarTopDefault = int64(30)
	)

	val := CityBusAPIEstimatedTimeOfArrival20321Params{
...
func (o *CityBusAPIEstimatedTimeOfArrival20321Params) WithTimeout(timeout time.Duration) *CityBusAPIEstimatedTimeOfArrival20321Params {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the city bus Api estimated time of arrival 2032 1 params
func (o *CityBusAPIEstimatedTimeOfArrival20321Params) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the city bus Api estimated time of arrival 2032 1 params
func (o *CityBusAPIEstimatedTimeOfArrival20321Params) WithContext(ctx context.Context) *CityBusAPIEstimatedTimeOfArrival20321Params {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the city bus Api estimated time of arrival 2032 1 params
func (o *CityBusAPIEstimatedTimeOfArrival20321Params) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the city bus Api estimated time of arrival 2032 1 params
func (o *CityBusAPIEstimatedTimeOfArrival20321Params) WithHTTPClient(client *http.Client) *CityBusAPIEstimatedTimeOfArrival20321Params {
...
func (o *CityBusAPIEstimatedTimeOfArrival20321Params) WithDollarFilter(dollarFilter *string) *CityBusAPIEstimatedTimeOfArrival20321Params {
...
func (o *CityBusAPIEstimatedTimeOfArrival20321Params) WithDollarFormat(dollarFormat string) *CityBusAPIEstimatedTimeOfArrival20321Params {
...
func (o *CityBusAPIEstimatedTimeOfArrival20321Params) WithDollarOrderby(dollarOrderby *string) *CityBusAPIEstimatedTimeOfArrival20321Params {
...
func (o *CityBusAPIEstimatedTimeOfArrival20321Params) WithDollarSelect(dollarSelect *string) *CityBusAPIEstimatedTimeOfArrival20321Params {
...
func (o *CityBusAPIEstimatedTimeOfArrival20321Params) WithDollarSkip(dollarSkip *string) *CityBusAPIEstimatedTimeOfArrival20321Params {
...
func (o *CityBusAPIEstimatedTimeOfArrival20321Params) WithDollarTop(dollarTop *int64) *CityBusAPIEstimatedTimeOfArrival20321Params {
...
func (o *CityBusAPIEstimatedTimeOfArrival20321Params) WithCity(city string) *CityBusAPIEstimatedTimeOfArrival20321Params {
	o.SetCity(city)
	return o
}

// SetCity adds the city to the city bus Api estimated time of arrival 2032 1 params
func (o *CityBusAPIEstimatedTimeOfArrival20321Params) SetCity(city string) {
	o.City = city
}

// WithRouteName adds the routeName to the city bus Api estimated time of arrival 2032 1 params
func (o *CityBusAPIEstimatedTimeOfArrival20321Params) WithRouteName(routeName string) *CityBusAPIEstimatedTimeOfArrival20321Params {
...
func (o *CityBusAPIEstimatedTimeOfArrival20321Params) WithHealth(health *string) *CityBusAPIEstimatedTimeOfArrival20321Params {
	o.SetHealth(health)
	return o
}

// SetHealth adds the health to the city bus Api estimated time of arrival 2032 1 params
func (o *CityBusAPIEstimatedTimeOfArrival20321Params) SetHealth(health *string) {
	o.Health = health
}

// WriteToRequest writes these params to a swagger request
func (o *CityBusAPIEstimatedTimeOfArrival20321Params) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
