...
func (o *CityBusAPIStation2037Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewCityBusAPIStation2037OK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 299:
		result := NewCityBusAPIStation2037Status299()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 304:
		result := NewCityBusAPIStation2037NotModified()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func NewCityBusAPIStation2037OK() *CityBusAPIStation2037OK {
	return &CityBusAPIStation2037OK{}
}
...
func (o *CityBusAPIStation2037OK) Error() string {
	return fmt.Sprintf("[GET /v2/Bus/Station/City/{City}][%d] cityBusApiStation2037OK  %+v", 200, o.Payload)
}
func (o *CityBusAPIStation2037OK) GetPayload() []*models.PTXServiceDTOBusSpecificationV2BusStation {
	return o.Payload
}

func (o *CityBusAPIStation2037OK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewCityBusAPIStation2037Status299() *CityBusAPIStation2037Status299 {
	return &CityBusAPIStation2037Status299{}
}
...
func (o *CityBusAPIStation2037Status299) Error() string {
	return fmt.Sprintf("[GET /v2/Bus/Station/City/{City}][%d] cityBusApiStation2037Status299  %+v", 299, o.Payload)
}
func (o *CityBusAPIStation2037Status299) GetPayload() *models.PTXServiceDTOSharedSpecificationV3BaseDisplayHealth {
	return o.Payload
}

func (o *CityBusAPIStation2037Status299) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewCityBusAPIStation2037NotModified() *CityBusAPIStation2037NotModified {
	return &CityBusAPIStation2037NotModified{}
}
...
func (o *CityBusAPIStation2037NotModified) Error() string {
	return fmt.Sprintf("[GET /v2/Bus/Station/City/{City}][%d] cityBusApiStation2037NotModified ", 304)
}

func (o *CityBusAPIStation2037NotModified) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
