...
// WithRouteName adds the routeName to the city bus Api first last trip info 2 params
func (o *CityBusAPIFirstLastTripInfo2Params) WithRouteName(routeName string) *CityBusAPIFirstLastTripInfo2Params {
	o.SetRouteName(routeName)
	return o
}

// SetRouteName adds the routeName to the city bus Api first last trip info 2 params
func (o *CityBusAPIFirstLastTripInfo2Params) SetRouteName(routeName string) {
