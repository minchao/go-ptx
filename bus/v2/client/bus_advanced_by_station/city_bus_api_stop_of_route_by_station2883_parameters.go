...
// NewCityBusAPIStopOfRouteByStation2883Params creates a new CityBusAPIStopOfRouteByStation2883Params object,
...
func NewCityBusAPIStopOfRouteByStation2883Params() *CityBusAPIStopOfRouteByStation2883Params {
	return &CityBusAPIStopOfRouteByStation2883Params{
		timeout: cr.DefaultTimeout,
	}
}

// NewCityBusAPIStopOfRouteByStation2883ParamsWithTimeout creates a new CityBusAPIStopOfRouteByStation2883Params object
...
// NewCityBusAPIStopOfRouteByStation2883ParamsWithContext creates a new CityBusAPIStopOfRouteByStation2883Params object
...
// NewCityBusAPIStopOfRouteByStation2883ParamsWithHTTPClient creates a new CityBusAPIStopOfRouteByStation2883Params object
...
func (o *CityBusAPIStopOfRouteByStation2883Params) WithDefaults() *CityBusAPIStopOfRouteByStation2883Params {
	o.SetDefaults()
	return o
}
...
//
// All values with no default are reset to their zero value.
func (o *CityBusAPIStopOfRouteByStation2883Params) SetDefaults() {
	var (
		dollarTopDefault = int64(30)
	)

	val := CityBusAPIStopOfRouteByStation2883Params{
...
func (o *CityBusAPIStopOfRouteByStation2883Params) WithTimeout(timeout time.Duration) *CityBusAPIStopOfRouteByStation2883Params {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the city bus Api stop of route by station 2883 params
func (o *CityBusAPIStopOfRouteByStation2883Params) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the city bus Api stop of route by station 2883 params
func (o *CityBusAPIStopOfRouteByStation2883Params) WithContext(ctx context.Context) *CityBusAPIStopOfRouteByStation2883Params {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the city bus Api stop of route by station 2883 params
func (o *CityBusAPIStopOfRouteByStation2883Params) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the city bus Api stop of route by station 2883 params
func (o *CityBusAPIStopOfRouteByStation2883Params) WithHTTPClient(client *http.Client) *CityBusAPIStopOfRouteByStation2883Params {
...
func (o *CityBusAPIStopOfRouteByStation2883Params) WithDollarFilter(dollarFilter *string) *CityBusAPIStopOfRouteByStation2883Params {
...
func (o *CityBusAPIStopOfRouteByStation2883Params) WithDollarFormat(dollarFormat string) *CityBusAPIStopOfRouteByStation2883Params {
...
func (o *CityBusAPIStopOfRouteByStation2883Params) WithDollarOrderby(dollarOrderby *string) *CityBusAPIStopOfRouteByStation2883Params {
...
func (o *CityBusAPIStopOfRouteByStation2883Params) WithDollarSelect(dollarSelect *string) *CityBusAPIStopOfRouteByStation2883Params {
...
func (o *CityBusAPIStopOfRouteByStation2883Params) WithDollarSkip(dollarSkip *string) *CityBusAPIStopOfRouteByStation2883Params {
...
func (o *CityBusAPIStopOfRouteByStation2883Params) WithDollarTop(dollarTop *int64) *CityBusAPIStopOfRouteByStation2883Params {
...
func (o *CityBusAPIStopOfRouteByStation2883Params) WithCity(city string) *CityBusAPIStopOfRouteByStation2883Params {
	o.SetCity(city)
	return o
}

// SetCity adds the city to the city bus Api stop of route by station 2883 params
func (o *CityBusAPIStopOfRouteByStation2883Params) SetCity(city string) {
	o.City = city
}

// WithStationID adds the stationID to the city bus Api stop of route by station 2883 params
func (o *CityBusAPIStopOfRouteByStation2883Params) WithStationID(stationID string) *CityBusAPIStopOfRouteByStation2883Params {
...
func (o *CityBusAPIStopOfRouteByStation2883Params) WithHealth(health *string) *CityBusAPIStopOfRouteByStation2883Params {
	o.SetHealth(health)
	return o
}
...
func (o *CityBusAPIStopOfRouteByStation2883Params) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
