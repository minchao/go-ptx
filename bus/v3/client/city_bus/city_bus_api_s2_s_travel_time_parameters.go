...
func (o *CityBusAPIS2STravelTimeParams) WithDollarCount(dollarCount *bool) *CityBusAPIS2STravelTimeParams {
	o.SetDollarCount(dollarCount)
	return o
}

// SetDollarCount adds the dollarCount to the city bus Api s2 s travel time params
func (o *CityBusAPIS2STravelTimeParams) SetDollarCount(dollarCount *bool) {
