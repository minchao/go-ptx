...
func (o *CityBusAPIRouteFareParams) WithDollarCount(dollarCount *bool) *CityBusAPIRouteFareParams {
	o.SetDollarCount(dollarCount)
	return o
}

// SetDollarCount adds the dollarCount to the city bus Api route fare params
func (o *CityBusAPIRouteFareParams) SetDollarCount(dollarCount *bool) {
