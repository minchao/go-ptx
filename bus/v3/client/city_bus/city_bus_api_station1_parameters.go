...
func (o *CityBusAPIStation1Params) WithDollarCount(dollarCount *string) *CityBusAPIStation1Params {
	o.SetDollarCount(dollarCount)
	return o
}

// SetDollarCount adds the dollarCount to the city bus Api station 1 params
func (o *CityBusAPIStation1Params) SetDollarCount(dollarCount *string) {
