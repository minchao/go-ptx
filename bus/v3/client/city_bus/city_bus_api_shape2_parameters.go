...
func (o *CityBusAPIShape2Params) WithDollarCount(dollarCount *string) *CityBusAPIShape2Params {
	o.SetDollarCount(dollarCount)
	return o
}

// SetDollarCount adds the dollarCount to the city bus Api shape 2 params
func (o *CityBusAPIShape2Params) SetDollarCount(dollarCount *string) {
