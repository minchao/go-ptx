...
func (o *CityBusAPIAlertParams) WithContext(ctx context.Context) *CityBusAPIAlertParams {
	o.SetContext(ctx)
	return o
}
...
func (o *CityBusAPIAlertParams) WithCity(city string) *CityBusAPIAlertParams {
	o.SetCity(city)
	return o
}
