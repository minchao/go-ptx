...
func (o *CityBusAPIRealTimeNearStopParams) WithDollarCount(dollarCount *bool) *CityBusAPIRealTimeNearStopParams {
	o.SetDollarCount(dollarCount)
	return o
}

// SetDollarCount adds the dollarCount to the city bus Api real time near stop params
func (o *CityBusAPIRealTimeNearStopParams) SetDollarCount(dollarCount *bool) {
