...
func (o *CityBusAPIScheduleParams) WithDollarCount(dollarCount *bool) *CityBusAPIScheduleParams {
	o.SetDollarCount(dollarCount)
	return o
}

// SetDollarCount adds the dollarCount to the city bus Api schedule params
func (o *CityBusAPIScheduleParams) SetDollarCount(dollarCount *bool) {
