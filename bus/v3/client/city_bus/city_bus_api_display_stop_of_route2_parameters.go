...
func (o *CityBusAPIDisplayStopOfRoute2Params) WithDollarCount(dollarCount *string) *CityBusAPIDisplayStopOfRoute2Params {
	o.SetDollarCount(dollarCount)
	return o
}

// SetDollarCount adds the dollarCount to the city bus Api display stop of route 2 params
func (o *CityBusAPIDisplayStopOfRoute2Params) SetDollarCount(dollarCount *string) {
