...
func (o *CityBusAPIRealTimeByFrequency3Params) WithDollarCount(dollarCount *string) *CityBusAPIRealTimeByFrequency3Params {
	o.SetDollarCount(dollarCount)
	return o
}

// SetDollarCount adds the dollarCount to the city bus Api real time by frequency 3 params
func (o *CityBusAPIRealTimeByFrequency3Params) SetDollarCount(dollarCount *string) {
