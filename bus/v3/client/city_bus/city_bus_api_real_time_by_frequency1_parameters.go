...
func (o *CityBusAPIRealTimeByFrequency1Params) WithDollarCount(dollarCount *bool) *CityBusAPIRealTimeByFrequency1Params {
	o.SetDollarCount(dollarCount)
	return o
}

// SetDollarCount adds the dollarCount to the city bus Api real time by frequency 1 params
func (o *CityBusAPIRealTimeByFrequency1Params) SetDollarCount(dollarCount *bool) {
