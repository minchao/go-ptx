...
func (o *CityBusAPIRealTimeNearStop2Params) WithDollarCount(dollarCount *string) *CityBusAPIRealTimeNearStop2Params {
	o.SetDollarCount(dollarCount)
	return o
}

// SetDollarCount adds the dollarCount to the city bus Api real time near stop 2 params
func (o *CityBusAPIRealTimeNearStop2Params) SetDollarCount(dollarCount *string) {
