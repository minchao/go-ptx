...
func (o *CityBusAPIRealTimeNearStop1Params) WithDollarCount(dollarCount *bool) *CityBusAPIRealTimeNearStop1Params {
	o.SetDollarCount(dollarCount)
	return o
}

// SetDollarCount adds the dollarCount to the city bus Api real time near stop 1 params
func (o *CityBusAPIRealTimeNearStop1Params) SetDollarCount(dollarCount *bool) {
