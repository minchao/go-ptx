...
func (o *CityBusAPIEstimatedTimeOfArrival30171Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewCityBusAPIEstimatedTimeOfArrival30171OK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 299:
		result := NewCityBusAPIEstimatedTimeOfArrival30171Status299()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 304:
		result := NewCityBusAPIEstimatedTimeOfArrival30171NotModified()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func NewCityBusAPIEstimatedTimeOfArrival30171OK() *CityBusAPIEstimatedTimeOfArrival30171OK {
	return &CityBusAPIEstimatedTimeOfArrival30171OK{}
}
...
func (o *CityBusAPIEstimatedTimeOfArrival30171OK) Error() string {
	return fmt.Sprintf("[GET /v3/Bus/EstimatedTimeOfArrival/City/{City}/{RouteName}][%d] cityBusApiEstimatedTimeOfArrival30171OK  %+v", 200, o.Payload)
}
func (o *CityBusAPIEstimatedTimeOfArrival30171OK) GetPayload() *models.PTXServiceDTOBusSpecificationV3WrapperBusWrapperPTXServiceDTOBusSpecificationV3N1Data {
	return o.Payload
}

func (o *CityBusAPIEstimatedTimeOfArrival30171OK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewCityBusAPIEstimatedTimeOfArrival30171Status299() *CityBusAPIEstimatedTimeOfArrival30171Status299 {
	return &CityBusAPIEstimatedTimeOfArrival30171Status299{}
}
...
func (o *CityBusAPIEstimatedTimeOfArrival30171Status299) Error() string {
	return fmt.Sprintf("[GET /v3/Bus/EstimatedTimeOfArrival/City/{City}/{RouteName}][%d] cityBusApiEstimatedTimeOfArrival30171Status299  %+v", 299, o.Payload)
}
func (o *CityBusAPIEstimatedTimeOfArrival30171Status299) GetPayload() *models.PTXServiceDTOSharedSpecificationV3BaseDisplayHealth {
	return o.Payload
}

func (o *CityBusAPIEstimatedTimeOfArrival30171Status299) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewCityBusAPIEstimatedTimeOfArrival30171NotModified() *CityBusAPIEstimatedTimeOfArrival30171NotModified {
	return &CityBusAPIEstimatedTimeOfArrival30171NotModified{}
}
...
func (o *CityBusAPIEstimatedTimeOfArrival30171NotModified) Error() string {
	return fmt.Sprintf("[GET /v3/Bus/EstimatedTimeOfArrival/City/{City}/{RouteName}][%d] cityBusApiEstimatedTimeOfArrival30171NotModified ", 304)
}

func (o *CityBusAPIEstimatedTimeOfArrival30171NotModified) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
