...
// NewCityBusAPIEstimatedTimeOfArrival30171Params creates a new CityBusAPIEstimatedTimeOfArrival30171Params object,
...
func NewCityBusAPIEstimatedTimeOfArrival30171Params() *CityBusAPIEstimatedTimeOfArrival30171Params {
	return &CityBusAPIEstimatedTimeOfArrival30171Params{
		timeout: cr.DefaultTimeout,
	}
}

// NewCityBusAPIEstimatedTimeOfArrival30171ParamsWithTimeout creates a new CityBusAPIEstimatedTimeOfArrival30171Params object
...
// NewCityBusAPIEstimatedTimeOfArrival30171ParamsWithContext creates a new CityBusAPIEstimatedTimeOfArrival30171Params object
...
// NewCityBusAPIEstimatedTimeOfArrival30171ParamsWithHTTPClient creates a new CityBusAPIEstimatedTimeOfArrival30171Params object
...
func (o *CityBusAPIEstimatedTimeOfArrival30171Params) WithDefaults() *CityBusAPIEstimatedTimeOfArrival30171Params {
	o.SetDefaults()
	return o
}
...
//
// All values with no default are reset to their zero value.
func (o *CityBusAPIEstimatedTimeOfArrival30171Params) SetDefaults() {
	var (
		dollarTopDefault = int64(30)
	)

	val := CityBusAPIEstimatedTimeOfArrival30171Params{
...
func (o *CityBusAPIEstimatedTimeOfArrival30171Params) WithTimeout(timeout time.Duration) *CityBusAPIEstimatedTimeOfArrival30171Params {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the city bus Api estimated time of arrival 3017 1 params
func (o *CityBusAPIEstimatedTimeOfArrival30171Params) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the city bus Api estimated time of arrival 3017 1 params
func (o *CityBusAPIEstimatedTimeOfArrival30171Params) WithContext(ctx context.Context) *CityBusAPIEstimatedTimeOfArrival30171Params {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the city bus Api estimated time of arrival 3017 1 params
func (o *CityBusAPIEstimatedTimeOfArrival30171Params) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the city bus Api estimated time of arrival 3017 1 params
func (o *CityBusAPIEstimatedTimeOfArrival30171Params) WithHTTPClient(client *http.Client) *CityBusAPIEstimatedTimeOfArrival30171Params {
...
func (o *CityBusAPIEstimatedTimeOfArrival30171Params) WithDollarCount(dollarCount *bool) *CityBusAPIEstimatedTimeOfArrival30171Params {
...
func (o *CityBusAPIEstimatedTimeOfArrival30171Params) WithDollarFilter(dollarFilter *string) *CityBusAPIEstimatedTimeOfArrival30171Params {
...
func (o *CityBusAPIEstimatedTimeOfArrival30171Params) WithDollarFormat(dollarFormat string) *CityBusAPIEstimatedTimeOfArrival30171Params {
...
func (o *CityBusAPIEstimatedTimeOfArrival30171Params) WithDollarOrderby(dollarOrderby *string) *CityBusAPIEstimatedTimeOfArrival30171Params {
...
func (o *CityBusAPIEstimatedTimeOfArrival30171Params) WithDollarSelect(dollarSelect *string) *CityBusAPIEstimatedTimeOfArrival30171Params {
...
func (o *CityBusAPIEstimatedTimeOfArrival30171Params) WithDollarSkip(dollarSkip *string) *CityBusAPIEstimatedTimeOfArrival30171Params {
...
func (o *CityBusAPIEstimatedTimeOfArrival30171Params) WithDollarTop(dollarTop *int64) *CityBusAPIEstimatedTimeOfArrival30171Params {
...
func (o *CityBusAPIEstimatedTimeOfArrival30171Params) WithCity(city string) *CityBusAPIEstimatedTimeOfArrival30171Params {
	o.SetCity(city)
	return o
}

// SetCity adds the city to the city bus Api estimated time of arrival 3017 1 params
func (o *CityBusAPIEstimatedTimeOfArrival30171Params) SetCity(city string) {
	o.City = city
}

// WithRouteName adds the routeName to the city bus Api estimated time of arrival 3017 1 params
func (o *CityBusAPIEstimatedTimeOfArrival30171Params) WithRouteName(routeName string) *CityBusAPIEstimatedTimeOfArrival30171Params {
...
func (o *CityBusAPIEstimatedTimeOfArrival30171Params) WithHealth(health *string) *CityBusAPIEstimatedTimeOfArrival30171Params {
	o.SetHealth(health)
	return o
}

// SetHealth adds the health to the city bus Api estimated time of arrival 3017 1 params
func (o *CityBusAPIEstimatedTimeOfArrival30171Params) SetHealth(health *string) {
	o.Health = health
}

// WriteToRequest writes these params to a swagger request
func (o *CityBusAPIEstimatedTimeOfArrival30171Params) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
