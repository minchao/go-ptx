...
func (o *CityBusAPIRoute2Params) WithDollarCount(dollarCount *string) *CityBusAPIRoute2Params {
	o.SetDollarCount(dollarCount)
	return o
}

// SetDollarCount adds the dollarCount to the city bus Api route 2 params
func (o *CityBusAPIRoute2Params) SetDollarCount(dollarCount *string) {
