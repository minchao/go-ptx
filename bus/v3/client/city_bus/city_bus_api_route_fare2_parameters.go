...
func (o *CityBusAPIRouteFare2Params) WithDollarCount(dollarCount *string) *CityBusAPIRouteFare2Params {
	o.SetDollarCount(dollarCount)
	return o
}

// SetDollarCount adds the dollarCount to the city bus Api route fare 2 params
func (o *CityBusAPIRouteFare2Params) SetDollarCount(dollarCount *string) {
