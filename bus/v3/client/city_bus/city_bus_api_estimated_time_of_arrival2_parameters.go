...
func (o *CityBusAPIEstimatedTimeOfArrival2Params) WithDollarCount(dollarCount *string) *CityBusAPIEstimatedTimeOfArrival2Params {
	o.SetDollarCount(dollarCount)
	return o
}

// SetDollarCount adds the dollarCount to the city bus Api estimated time of arrival 2 params
func (o *CityBusAPIEstimatedTimeOfArrival2Params) SetDollarCount(dollarCount *string) {
