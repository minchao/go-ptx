...
func (o *CityBusAPIDisplayStopOfRouteOK) GetPayload() *models.PTXServiceDTOBusSpecificationV3WrapperBusVWrapperPTXServiceDTOBusSpecificationV3DisplayStopOfRoute {
	return o.Payload
}
