...
func (o *CityBusAPIEstimatedTimeOfArrival3Params) WithDollarCount(dollarCount *string) *CityBusAPIEstimatedTimeOfArrival3Params {
	o.SetDollarCount(dollarCount)
	return o
}

// SetDollarCount adds the dollarCount to the city bus Api estimated time of arrival 3 params
func (o *CityBusAPIEstimatedTimeOfArrival3Params) SetDollarCount(dollarCount *string) {
