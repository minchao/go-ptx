...
func (o *CityBusAPIVehicle1Params) WithDollarCount(dollarCount *string) *CityBusAPIVehicle1Params {
	o.SetDollarCount(dollarCount)
	return o
}

// SetDollarCount adds the dollarCount to the city bus Api vehicle 1 params
func (o *CityBusAPIVehicle1Params) SetDollarCount(dollarCount *string) {
