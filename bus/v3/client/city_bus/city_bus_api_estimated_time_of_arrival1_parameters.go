...
func (o *CityBusAPIEstimatedTimeOfArrival1Params) WithDollarCount(dollarCount *bool) *CityBusAPIEstimatedTimeOfArrival1Params {
	o.SetDollarCount(dollarCount)
	return o
}

// SetDollarCount adds the dollarCount to the city bus Api estimated time of arrival 1 params
func (o *CityBusAPIEstimatedTimeOfArrival1Params) SetDollarCount(dollarCount *bool) {
