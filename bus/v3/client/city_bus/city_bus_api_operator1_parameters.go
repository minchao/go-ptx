...
func (o *CityBusAPIOperator1Params) WithDollarCount(dollarCount *string) *CityBusAPIOperator1Params {
	o.SetDollarCount(dollarCount)
	return o
}

// SetDollarCount adds the dollarCount to the city bus Api operator 1 params
func (o *CityBusAPIOperator1Params) SetDollarCount(dollarCount *string) {
