...
func (o *CityBusAPIRealTimeByFrequency2Params) WithDollarCount(dollarCount *string) *CityBusAPIRealTimeByFrequency2Params {
	o.SetDollarCount(dollarCount)
	return o
}

// SetDollarCount adds the dollarCount to the city bus Api real time by frequency 2 params
func (o *CityBusAPIRealTimeByFrequency2Params) SetDollarCount(dollarCount *string) {
