...
func (o *CityBusAPIFirstLastTripInfoParams) WithDollarCount(dollarCount *bool) *CityBusAPIFirstLastTripInfoParams {
	o.SetDollarCount(dollarCount)
	return o
}

// SetDollarCount adds the dollarCount to the city bus Api first last trip info params
func (o *CityBusAPIFirstLastTripInfoParams) SetDollarCount(dollarCount *bool) {
