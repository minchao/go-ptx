...
func (o *CityBusAPIStopOfRouteParams) WithDollarCount(dollarCount *bool) *CityBusAPIStopOfRouteParams {
	o.SetDollarCount(dollarCount)
	return o
}

// SetDollarCount adds the dollarCount to the city bus Api stop of route params
func (o *CityBusAPIStopOfRouteParams) SetDollarCount(dollarCount *bool) {
