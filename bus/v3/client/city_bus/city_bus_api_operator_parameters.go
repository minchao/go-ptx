...
func (o *CityBusAPIOperatorParams) WithDollarCount(dollarCount *bool) *CityBusAPIOperatorParams {
	o.SetDollarCount(dollarCount)
	return o
}

// SetDollarCount adds the dollarCount to the city bus Api operator params
func (o *CityBusAPIOperatorParams) SetDollarCount(dollarCount *bool) {
