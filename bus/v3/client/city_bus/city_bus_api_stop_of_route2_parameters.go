...
func (o *CityBusAPIStopOfRoute2Params) WithDollarCount(dollarCount *string) *CityBusAPIStopOfRoute2Params {
	o.SetDollarCount(dollarCount)
	return o
}

// SetDollarCount adds the dollarCount to the city bus Api stop of route 2 params
func (o *CityBusAPIStopOfRoute2Params) SetDollarCount(dollarCount *string) {
