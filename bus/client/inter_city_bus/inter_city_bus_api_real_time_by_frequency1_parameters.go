...
func (o *InterCityBusAPIRealTimeByFrequency1Params) WithDollarTop(dollarTop *string) *InterCityBusAPIRealTimeByFrequency1Params {
	o.SetDollarTop(dollarTop)
	return o
}

// SetDollarTop adds the dollarTop to the inter city bus Api real time by frequency 1 params
func (o *InterCityBusAPIRealTimeByFrequency1Params) SetDollarTop(dollarTop *string) {
