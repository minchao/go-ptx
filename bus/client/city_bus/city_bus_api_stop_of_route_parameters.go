...
func (o *CityBusAPIStopOfRouteParams) WithDollarTop(dollarTop *string) *CityBusAPIStopOfRouteParams {
	o.SetDollarTop(dollarTop)
	return o
}

// SetDollarTop adds the dollarTop to the city bus Api stop of route params
func (o *CityBusAPIStopOfRouteParams) SetDollarTop(dollarTop *string) {
