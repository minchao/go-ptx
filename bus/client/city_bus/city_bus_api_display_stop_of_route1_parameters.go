...
func (o *CityBusAPIDisplayStopOfRoute1Params) WithDollarTop(dollarTop *string) *CityBusAPIDisplayStopOfRoute1Params {
	o.SetDollarTop(dollarTop)
	return o
}

// SetDollarTop adds the dollarTop to the city bus Api display stop of route 1 params
func (o *CityBusAPIDisplayStopOfRoute1Params) SetDollarTop(dollarTop *string) {
