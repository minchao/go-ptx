...
const (
	...
	// ServiceDTOVersion2TaiwanTripBusBusTaiwanTripShapeDirectionNr0去程 captures enum value "0: 去程"
	ServiceDTOVersion2TaiwanTripBusBusTaiwanTripShapeDirectionNr0去程 string = "0: 去程"

	// ServiceDTOVersion2TaiwanTripBusBusTaiwanTripShapeDirectionNr1返程 captures enum value "1: 返程"
	ServiceDTOVersion2TaiwanTripBusBusTaiwanTripShapeDirectionNr1返程 string = "1: 返程"

	// ServiceDTOVersion2TaiwanTripBusBusTaiwanTripShapeDirectionNr2迴圈 captures enum value "2: 迴圈"
	ServiceDTOVersion2TaiwanTripBusBusTaiwanTripShapeDirectionNr2迴圈 string = "2: 迴圈"

	// ServiceDTOVersion2TaiwanTripBusBusTaiwanTripShapeDirectionNr255未知 captures enum value "255: 未知"
	ServiceDTOVersion2TaiwanTripBusBusTaiwanTripShapeDirectionNr255未知 string = "255: 未知"
)

// prop value enum
func (m *ServiceDTOVersion2TaiwanTripBusBusTaiwanTripShape) validateDirectionEnum(path, location string, value string) error {
