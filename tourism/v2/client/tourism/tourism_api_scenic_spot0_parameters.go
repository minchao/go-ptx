...
// WithHealth adds the health to the tourism Api scenic spot 0 params
func (o *TourismAPIScenicSpot0Params) WithHealth(health *string) *TourismAPIScenicSpot0Params {
	o.SetHealth(health)
	return o
}

// SetHealth adds the health to the tourism Api scenic spot 0 params
func (o *TourismAPIScenicSpot0Params) SetHealth(health *string) {
	o.Health = health
}
