...
// WithHealth adds the health to the tourism Api hotel 0 params
func (o *TourismAPIHotel0Params) WithHealth(health *string) *TourismAPIHotel0Params {
	o.SetHealth(health)
	return o
}

// SetHealth adds the health to the tourism Api hotel 0 params
func (o *TourismAPIHotel0Params) SetHealth(health *string) {
	o.Health = health
}
