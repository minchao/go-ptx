...
// WithHealth adds the health to the tourism Api scenic spot params
func (o *TourismAPIScenicSpotParams) WithHealth(health *string) *TourismAPIScenicSpotParams {
	o.SetHealth(health)
	return o
}

// SetHealth adds the health to the tourism Api scenic spot params
func (o *TourismAPIScenicSpotParams) SetHealth(health *string) {
	o.Health = health
}
