...
// WithDollarSpatialFilter adds the dollarSpatialFilter to the tourism Api restaurant 2242 params
func (o *TourismAPIRestaurant2242Params) WithDollarSpatialFilter(dollarSpatialFilter *string) *TourismAPIRestaurant2242Params {
	o.SetDollarSpatialFilter(dollarSpatialFilter)
	return o
}

// SetDollarSpatialFilter adds the dollarSpatialFilter to the tourism Api restaurant 2242 params
func (o *TourismAPIRestaurant2242Params) SetDollarSpatialFilter(dollarSpatialFilter *string) {
