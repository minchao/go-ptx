...
// WithHealth adds the health to the taiwan trip bus Api real time near stop 1 params
func (o *TaiwanTripBusAPIRealTimeNearStop1Params) WithHealth(health *string) *TaiwanTripBusAPIRealTimeNearStop1Params {
	o.SetHealth(health)
	return o
}

// SetHealth adds the health to the taiwan trip bus Api real time near stop 1 params
func (o *TaiwanTripBusAPIRealTimeNearStop1Params) SetHealth(health *string) {
	o.Health = health
}
