...
// WithHealth adds the health to the tourism Api restaurant params
func (o *TourismAPIRestaurantParams) WithHealth(health *string) *TourismAPIRestaurantParams {
	o.SetHealth(health)
	return o
}

// SetHealth adds the health to the tourism Api restaurant params
func (o *TourismAPIRestaurantParams) SetHealth(health *string) {
	o.Health = health
}
