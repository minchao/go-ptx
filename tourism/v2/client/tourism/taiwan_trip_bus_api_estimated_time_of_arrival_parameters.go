...
// WithHealth adds the health to the taiwan trip bus Api estimated time of arrival params
func (o *TaiwanTripBusAPIEstimatedTimeOfArrivalParams) WithHealth(health *string) *TaiwanTripBusAPIEstimatedTimeOfArrivalParams {
	o.SetHealth(health)
	return o
}

// SetHealth adds the health to the taiwan trip bus Api estimated time of arrival params
func (o *TaiwanTripBusAPIEstimatedTimeOfArrivalParams) SetHealth(health *string) {
	o.Health = health
}
