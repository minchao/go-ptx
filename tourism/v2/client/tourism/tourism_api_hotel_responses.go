...
func (o *TourismAPIHotelReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 299:
		result := NewTourismAPIHotelStatus299()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
...
// NewTourismAPIHotelStatus299 creates a TourismAPIHotelStatus299 with default headers values
func NewTourismAPIHotelStatus299() *TourismAPIHotelStatus299 {
	return &TourismAPIHotelStatus299{}
}

/* TourismAPIHotelStatus299 describes a response with status code 299, with default header values.

加入參數'?health=true'即可查詢此API服務的健康狀態
*/
type TourismAPIHotelStatus299 struct {
	Payload *models.PTXServiceDTOSharedSpecificationV3BaseDisplayHealth
}

func (o *TourismAPIHotelStatus299) Error() string {
	return fmt.Sprintf("[GET /v2/Tourism/Hotel][%d] tourismApiHotelStatus299  %+v", 299, o.Payload)
}
func (o *TourismAPIHotelStatus299) GetPayload() *models.PTXServiceDTOSharedSpecificationV3BaseDisplayHealth {
	return o.Payload
}

func (o *TourismAPIHotelStatus299) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
