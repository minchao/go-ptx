...
// WithHealth adds the health to the taiwan trip bus Api route params
func (o *TaiwanTripBusAPIRouteParams) WithHealth(health *string) *TaiwanTripBusAPIRouteParams {
	o.SetHealth(health)
	return o
}

// SetHealth adds the health to the taiwan trip bus Api route params
func (o *TaiwanTripBusAPIRouteParams) SetHealth(health *string) {
	o.Health = health
}
