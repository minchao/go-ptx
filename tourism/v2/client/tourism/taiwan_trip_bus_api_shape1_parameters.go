...
// WithHealth adds the health to the taiwan trip bus Api shape 1 params
func (o *TaiwanTripBusAPIShape1Params) WithHealth(health *string) *TaiwanTripBusAPIShape1Params {
	o.SetHealth(health)
	return o
}

// SetHealth adds the health to the taiwan trip bus Api shape 1 params
func (o *TaiwanTripBusAPIShape1Params) SetHealth(health *string) {
	o.Health = health
}
