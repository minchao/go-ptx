...
func (o *TourismAPIActivity0Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	case 299:
		result := NewTourismAPIActivity0Status299()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
...
// NewTourismAPIActivity0Status299 creates a TourismAPIActivity0Status299 with default headers values
func NewTourismAPIActivity0Status299() *TourismAPIActivity0Status299 {
	return &TourismAPIActivity0Status299{}
}

/* TourismAPIActivity0Status299 describes a response with status code 299, with default header values.

加入參數'?health=true'即可查詢此API服務的健康狀態
*/
type TourismAPIActivity0Status299 struct {
	Payload *models.PTXServiceDTOSharedSpecificationV3BaseDisplayHealth
}

func (o *TourismAPIActivity0Status299) Error() string {
	return fmt.Sprintf("[GET /v2/Tourism/Activity/{City}][%d] tourismApiActivity0Status299  %+v", 299, o.Payload)
}
func (o *TourismAPIActivity0Status299) GetPayload() *models.PTXServiceDTOSharedSpecificationV3BaseDisplayHealth {
	return o.Payload
}

func (o *TourismAPIActivity0Status299) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
