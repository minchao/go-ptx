...
// WithHealth adds the health to the taiwan trip bus Api schedule 1 params
func (o *TaiwanTripBusAPISchedule1Params) WithHealth(health *string) *TaiwanTripBusAPISchedule1Params {
	o.SetHealth(health)
	return o
}

// SetHealth adds the health to the taiwan trip bus Api schedule 1 params
func (o *TaiwanTripBusAPISchedule1Params) SetHealth(health *string) {
	o.Health = health
}
