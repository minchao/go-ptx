...
func (o *TaiwanTripBusAPIShape1Params) WithDollarTop(dollarTop *string) *TaiwanTripBusAPIShape1Params {
	o.SetDollarTop(dollarTop)
	return o
}

// SetDollarTop adds the dollarTop to the taiwan trip bus Api shape 1 params
func (o *TaiwanTripBusAPIShape1Params) SetDollarTop(dollarTop *string) {
