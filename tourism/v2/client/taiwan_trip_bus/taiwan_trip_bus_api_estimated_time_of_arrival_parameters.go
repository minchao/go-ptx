...
func (o *TaiwanTripBusAPIEstimatedTimeOfArrivalParams) WithDollarTop(dollarTop *string) *TaiwanTripBusAPIEstimatedTimeOfArrivalParams {
	o.SetDollarTop(dollarTop)
	return o
}

// SetDollarTop adds the dollarTop to the taiwan trip bus Api estimated time of arrival params
func (o *TaiwanTripBusAPIEstimatedTimeOfArrivalParams) SetDollarTop(dollarTop *string) {
