...
func (o *TaiwanTripBusAPIRealTimeNearStopParams) WithDollarTop(dollarTop *string) *TaiwanTripBusAPIRealTimeNearStopParams {
	o.SetDollarTop(dollarTop)
	return o
}

// SetDollarTop adds the dollarTop to the taiwan trip bus Api real time near stop params
func (o *TaiwanTripBusAPIRealTimeNearStopParams) SetDollarTop(dollarTop *string) {
