...
var serviceDTOVersion2BusBusSubRouteTypeDirectionPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		serviceDTOVersion2BusBusSubRouteTypeDirectionPropEnum = append(serviceDTOVersion2BusBusSubRouteTypeDirectionPropEnum, v)
	}
}

const (

	// ServiceDTOVersion2BusBusSubRouteDirectionNr0去程 captures enum value "0: 去程"
	ServiceDTOVersion2BusBusSubRouteDirectionNr0去程 string = "0: 去程"

	// ServiceDTOVersion2BusBusSubRouteDirectionNr1返程 captures enum value "1: 返程"
	ServiceDTOVersion2BusBusSubRouteDirectionNr1返程 string = "1: 返程"

	// ServiceDTOVersion2BusBusSubRouteDirectionNr2迴圈 captures enum value "2: 迴圈"
	ServiceDTOVersion2BusBusSubRouteDirectionNr2迴圈 string = "2: 迴圈"

	// ServiceDTOVersion2BusBusSubRouteDirectionNr255未知 captures enum value "255: 未知"
	ServiceDTOVersion2BusBusSubRouteDirectionNr255未知 string = "255: 未知"
)

// prop value enum
func (m *ServiceDTOVersion2BusBusSubRoute) validateDirectionEnum(path, location string, value string) error {
	if err := validate.Enum(path, location, value, serviceDTOVersion2BusBusSubRouteTypeDirectionPropEnum); err != nil {
		return err
	}
	return nil
}
