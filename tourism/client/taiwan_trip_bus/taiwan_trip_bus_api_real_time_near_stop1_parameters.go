...
func (o *TaiwanTripBusAPIRealTimeNearStop1Params) WithDollarTop(dollarTop *string) *TaiwanTripBusAPIRealTimeNearStop1Params {
	o.SetDollarTop(dollarTop)
	return o
}

// SetDollarTop adds the dollarTop to the taiwan trip bus Api real time near stop 1 params
func (o *TaiwanTripBusAPIRealTimeNearStop1Params) SetDollarTop(dollarTop *string) {
