...
func (o *TaiwanTripBusAPISchedule1Params) WithDollarTop(dollarTop *string) *TaiwanTripBusAPISchedule1Params {
	o.SetDollarTop(dollarTop)
	return o
}

// SetDollarTop adds the dollarTop to the taiwan trip bus Api schedule 1 params
func (o *TaiwanTripBusAPISchedule1Params) SetDollarTop(dollarTop *string) {
