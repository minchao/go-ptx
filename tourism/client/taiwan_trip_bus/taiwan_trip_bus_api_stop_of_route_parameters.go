...
func (o *TaiwanTripBusAPIStopOfRouteParams) WithDollarTop(dollarTop *string) *TaiwanTripBusAPIStopOfRouteParams {
	o.SetDollarTop(dollarTop)
	return o
}

// SetDollarTop adds the dollarTop to the taiwan trip bus Api stop of route params
func (o *TaiwanTripBusAPIStopOfRouteParams) SetDollarTop(dollarTop *string) {
