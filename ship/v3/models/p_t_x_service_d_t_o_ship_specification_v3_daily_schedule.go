...
func (m *PTXServiceDTOShipSpecificationV3DailySchedule) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PTXServiceDTOShipSpecificationV3DailySchedule) validateDate(formats strfmt.Registry) error {
...
func (m *PTXServiceDTOShipSpecificationV3DailySchedule) validateFrequencies(formats strfmt.Registry) error {
...
func (m *PTXServiceDTOShipSpecificationV3DailySchedule) validateOperatorID(formats strfmt.Registry) error {
...
func (m *PTXServiceDTOShipSpecificationV3DailySchedule) validateRouteID(formats strfmt.Registry) error {
...
func (m *PTXServiceDTOShipSpecificationV3DailySchedule) validateRouteName(formats strfmt.Registry) error {

	return nil
}

func (m *PTXServiceDTOShipSpecificationV3DailySchedule) validateTimetables(formats strfmt.Registry) error {
...
func (m *PTXServiceDTOShipSpecificationV3DailySchedule) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *PTXServiceDTOShipSpecificationV3DailySchedule) contextValidateFrequencies(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PTXServiceDTOShipSpecificationV3DailySchedule) contextValidateRouteName(ctx context.Context, formats strfmt.Registry) error {

	return nil
}

func (m *PTXServiceDTOShipSpecificationV3DailySchedule) contextValidateTimetables(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PTXServiceDTOShipSpecificationV3DailySchedule) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *PTXServiceDTOShipSpecificationV3DailySchedule) UnmarshalBinary(b []byte) error {
	var res PTXServiceDTOShipSpecificationV3DailySchedule
