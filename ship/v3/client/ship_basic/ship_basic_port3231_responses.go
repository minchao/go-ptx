...
func (o *ShipBasicPort3231OK) Error() string {
	return fmt.Sprintf("[GET /v3/Ship/Basic/Port][%d] shipBasicPort3231OK  %+v", 200, o.Payload)
}
...
func (o *ShipBasicPort3231Status299) Error() string {
	return fmt.Sprintf("[GET /v3/Ship/Basic/Port][%d] shipBasicPort3231Status299  %+v", 299, o.Payload)
}
...
func (o *ShipBasicPort3231NotModified) Error() string {
	return fmt.Sprintf("[GET /v3/Ship/Basic/Port][%d] shipBasicPort3231NotModified ", 304)
}
