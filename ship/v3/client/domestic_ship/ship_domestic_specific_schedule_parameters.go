...
// NewShipDomesticSpecificScheduleParams creates a new ShipDomesticSpecificScheduleParams object,
...
func NewShipDomesticSpecificScheduleParams() *ShipDomesticSpecificScheduleParams {
	return &ShipDomesticSpecificScheduleParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewShipDomesticSpecificScheduleParamsWithTimeout creates a new ShipDomesticSpecificScheduleParams object
...
// NewShipDomesticSpecificScheduleParamsWithContext creates a new ShipDomesticSpecificScheduleParams object
...
// NewShipDomesticSpecificScheduleParamsWithHTTPClient creates a new ShipDomesticSpecificScheduleParams object
...
func (o *ShipDomesticSpecificScheduleParams) WithDefaults() *ShipDomesticSpecificScheduleParams {
	o.SetDefaults()
	return o
}
...
func (o *ShipDomesticSpecificScheduleParams) SetDefaults() {
	...
	val := ShipDomesticSpecificScheduleParams{
...
func (o *ShipDomesticSpecificScheduleParams) WithTimeout(timeout time.Duration) *ShipDomesticSpecificScheduleParams {
...
func (o *ShipDomesticSpecificScheduleParams) WithContext(ctx context.Context) *ShipDomesticSpecificScheduleParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the ship domestic specific schedule params
func (o *ShipDomesticSpecificScheduleParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the ship domestic specific schedule params
func (o *ShipDomesticSpecificScheduleParams) WithHTTPClient(client *http.Client) *ShipDomesticSpecificScheduleParams {
...
func (o *ShipDomesticSpecificScheduleParams) WithDollarCount(dollarCount *bool) *ShipDomesticSpecificScheduleParams {
...
func (o *ShipDomesticSpecificScheduleParams) WithDollarFilter(dollarFilter *string) *ShipDomesticSpecificScheduleParams {
...
func (o *ShipDomesticSpecificScheduleParams) WithDollarFormat(dollarFormat string) *ShipDomesticSpecificScheduleParams {
...
func (o *ShipDomesticSpecificScheduleParams) WithDollarOrderby(dollarOrderby *string) *ShipDomesticSpecificScheduleParams {
...
func (o *ShipDomesticSpecificScheduleParams) WithDollarSelect(dollarSelect *string) *ShipDomesticSpecificScheduleParams {
...
func (o *ShipDomesticSpecificScheduleParams) WithDollarSkip(dollarSkip *string) *ShipDomesticSpecificScheduleParams {
...
func (o *ShipDomesticSpecificScheduleParams) WithDollarTop(dollarTop *int64) *ShipDomesticSpecificScheduleParams {
...
func (o *ShipDomesticSpecificScheduleParams) WithCity(city string) *ShipDomesticSpecificScheduleParams {
	o.SetCity(city)
	return o
}
...
func (o *ShipDomesticSpecificScheduleParams) WithHealth(health *string) *ShipDomesticSpecificScheduleParams {
	o.SetHealth(health)
	return o
}
...
func (o *ShipDomesticSpecificScheduleParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
