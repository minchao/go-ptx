...
func (o *ShipInternationalLivePosition3237OK) Error() string {
	return fmt.Sprintf("[GET /v3/Ship/LivePosition/International][%d] shipInternationalLivePosition3237OK  %+v", 200, o.Payload)
}
...
func (o *ShipInternationalLivePosition3237Status299) Error() string {
	return fmt.Sprintf("[GET /v3/Ship/LivePosition/International][%d] shipInternationalLivePosition3237Status299  %+v", 299, o.Payload)
}
...
func (o *ShipInternationalLivePosition3237NotModified) Error() string {
	return fmt.Sprintf("[GET /v3/Ship/LivePosition/International][%d] shipInternationalLivePosition3237NotModified ", 304)
}
